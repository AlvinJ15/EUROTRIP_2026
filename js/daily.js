...
const DAILY = {
  ...
  overrides: {
    ...
    21: { note: '🛴 Cart + trottibike + gondola (~CHF 55–60 each), Schilthorn (CHF 54 each with the card) and Allmendhubel are on the activities line. Piz Gloria lunch IS in here — it is food.' },
