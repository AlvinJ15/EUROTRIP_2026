...
const DAILY = {
  ...
  overrides: {
    ...
    21: { note: '🛴 Cart + gondola + Pfingstegg toboggan (~CHF 75–80 each) and Schilthorn (CHF 54 each with the card) are on the activities line. Piz Gloria lunch IS in here — it is food.' },
