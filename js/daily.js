...
const DAILY = {
  ...
  overrides: {
    ...
    21: { note: '🏔️ Schilthorn (CHF 54 each with the card) and Männlichen + Kleine Scheidegg trains (~CHF 32) are on the activities line. Lunch in Lauterbrunnen and the Piz Gloria coffee ARE in here — they are food.' },
