...
const BUDGET = {
  ...
  total: { min: 14008, max: 18941, target: 15000 },
  savingTips: [
    ...
    "🎯 TARGET IS $15,000 WITH A CUSHION — not a hard ceiling. That reframes everything below. The floor of this trip is $14,008, comfortably under. The realistic landing zone is ~$15,800–16,500, so you are looking at roughly $800–1,500 over target, absorbed by the cushion rather than requiring cuts. The $18,941 maximum is every single category landing at the top of its range simultaneously, which does not happen.",
    "📈 THE EVIDENCE SO FAR SUPPORTS THE LOWER END. Four bookings in: the Barcelona Airbnb came in BELOW its estimated floor, Disney Sep 23 landed on its midpoint, Sagrada slightly above midpoint, the AVE above midpoint. Net, you are tracking the middle of the range, not the top — and you are booking early, which is what keeps it there. Nothing here needs cutting today.",
