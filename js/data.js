...
const ITINERARY = [
  ...
  },
  {
    ...
    dayByDay: [
      ...
      { day: "Sep 20 (Sun)", plan: "🔴 EARLY START — TAKE THE ~08:15 TRAIN, NOT THE 09:30. Check out, Zermatt→Visp→Interlaken Ost (~2h15 with one change at Visp), arrive ~10:30. 🧳 Bags into the lockers at Interlaken Ost. 🪂 TANDEM PARAGLIDE FROM BEATENBERG — book the ~13:00 slot: 20–30 min in the air over Lake Thun and Lake Brienz with the Eiger–Mönch–Jungfrau wall behind you, landing back in Interlaken. This is the green-and-turquoise Switzerland shot. ⚠️ WHY THE EARLY TRAIN: the whole paraglide is 2h–2h30 door to door (check-in and weigh-in 15 min · minibus up 25–30 min · briefing and wait 15–30 min · flight 20–30 min · landing and photos 15 min), and the operator office is in central Interlaken near Höhematte, a ~15-min walk from Ost — not at the station. Arriving 11:30 for a 12:00 slot was 30 minutes with zero slack, and these slots are not held for late arrivals. Collect bags ~15:30, train to Grindelwald, check in ~16:00, Pfingstegg still fits before it closes ~17:00." }
    ],
    highlights: [
  ...
  },
  {
    ...
    tips: [
      ...
      "🔴 BUDGET 2h–2h30 FOR THE PARAGLIDE, NOT ONE HOUR. The flight is 20–30 minutes; the process around it is not. Check-in and weigh-in ~15 min · minibus up to Beatenberg 25–30 min · briefing, harness and waiting your turn 15–30 min · flight 20–30 min · landing back in Interlaken, photos and video ~15 min. Plan the whole afternoon around it, not a slot in it.",
      "🔴 THREE THINGS TO ASK WHEN YOU BOOK: (1) Where exactly is the meeting point? Most Interlaken operators meet at their own office in the centre near Höhematte, a ~15-min walk from Interlaken Ost — but several will collect you AT Interlaken Ost, which removes the tightest part of the day. (2) Free cancellation, non-negotiable, it is a wind-dependent sport. (3) How long is the full process on their operation — take their number over any estimate here.",
      "✅ SEP 21 IS NOW YOUR PARAGLIDE BACKUP DAY, and this is the most valuable thing the second Grindelwald night bought. If Sep 20 is windy, cancelled, or simply runs late, fly on Sep 21 morning instead — Interlaken is 35 min from Grindelwald — and push First to the afternoon, where the gondola runs until ~17:00–18:00 and the Cliff Walk plus the Flieger fit comfortably. A two-day window is the strongest possible protection for a weather-dependent activity. If BOTH days blow out, Harder Kulm gives you the same two-lake panorama by funicular.",
...
const BUDGET = {
  ...
  total: { min: 14840, max: 19043, target: 15000 },
  savingTips: [
    ...
    "✅ $3,752 CONFIRMED PAID — AND EVERY COMMITTED BOOKING NOW HAS A REAL FIGURE: Lima↔Madrid flights $2,022 · Le Jules Verne $705 · Barcelona Airbnb $272 · AVE $243 · Madrid→Craiova $215 · Disneyland Park Sep 23 $213 · Sagrada Família $82. That is 25% of the target, and there is nothing left in the 'booked but unpriced' column — the number you see is the number you have spent.",
    "🎯 TARGET IS $15,000 WITH A CUSHION — not a hard ceiling. Floor $14,840, realistic landing ~$16,400–17,000, ceiling $19,043 (every category topping out at once, which does not happen). Expect roughly $1,400–2,000 into the cushion. ✅ With 25% of the trip paid and every committed figure known, that estimate is now built on real prices for the biggest lines rather than guesses — it will not swing much further.",
    ...
    "🎯 LEVERS IF YOU EVER WANT THEM — kept on file, not recommended today: Täsch instead of Zermatt village (~$80/night) · drop Segovia and just do the Madrid dino museum (~$60) · skip the chocolate workshop (~$145) · skip the Santorini caldera boat (~$100). ⚠️ Skipping the second Disney day is NOT on this list any more: Adventure World reopened 29 Mar 2026 as a genuine full-day park with 13 attractions and its own nighttime show. ✅ You have already banked the two big Disney savings by skipping the hopper (~€40) and Premier Access Ultimate (~€220–460).",
