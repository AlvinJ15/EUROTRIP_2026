...
const ITINERARY = [
  ...
  },
  {
    ...
    dayByDay: [
      ...
      { day: "Sep 18 (Fri)", plan: "🔴 THIS ENTRY WAS STALE AND IS NOW CORRECTED — it still routed you to ZERMATT on a SWISS TRAVEL PASS, and neither exists on this trip any more. ✈️ Morning flight Rome (FCO) → Geneva (1h50), booked before ~11:00. 🚂 Then Geneva airport → Bern → Interlaken Ost → Grindelwald, ~2h35, at HALF FARE with the card (~CHF 39/person) — buy a FLEXIBLE ticket, not a Supersaver, because you are arriving off a flight and a delay would void a train-specific fare. 💡 Buy the Sep 22 tickets at the same Geneva machine while you are there and forget about them. 🏔️ Arrive Grindelwald ~15:15. 🛷 PFINGSTEGG TOBOGGAN if you have the energy — own cable car from the village, 736m run, ~CHF 10, ~5 min queues, closes ~17:00. Otherwise a village walk under the Eiger north face, early dinner, sleep. 🌅 OPTIONAL BEFORE YOU LEAVE ROME, and it needs no ticket so decide it that morning: ST PETER'S SQUARE AT SUNRISE. Out at 06:15, blue hour ~06:20–06:50, sunrise ~06:55, back for the bags by 07:00. ✅ WORTH MORE THAN IT LOOKS, because the basilica FACES EAST: the rising sun hits the facade directly, and the square is genuinely empty at that hour. Sep 16 gives you it floodlit against a dark sky, this gives you warm light on the stone with nobody in frame — two different photographs, not the same one twice. ⚠️ THE COST IS A ~05:45 ALARM in front of a flight, two trains and a mountain arrival. Nothing is lost by skipping it, and since the whole Vatican stop is exterior-only there is no ticket, queue or opening time pulling you either way." }
    ],
    highlights: [
...
const BOOKINGS = [
  ...
  { priority: 23, what: "🔴 Grindelwald, SEP 18→19 — the last Swiss bed, and it is expensive", when: "🔴 NOW", urgency: "high", note: "🔴 THE WARNING ON THIS ENTRY CAME TRUE: the $150–240 estimate is dead, Grindelwald starts at ~$350 and most listings are $500+. Fri Sep 18 is a weekend night before the Sat Sep 19 Alpkäsefest, which may be part of it. ⚖️ RECOMMENDATION: PAY THE $350. It is one night and it is the one protecting Sep 19 — bags to the Spinne in the village, then straight up First, with no train in front of it. 🔍 THREE CHECKS FIRST, ten minutes: (1) price Sep 17 and Sep 20 in Grindelwald to tell event pricing from plain season; (2) try BURGLAUENEN, SCHWENDI, GRUND and WILDERSWIL — small halts on the same line, 5–25 min out, usually far cheaper; (3) ask the SPINNE for Sep 18 too, which would delete the Sep 19 bag-walk and add a spa evening. ✅ NEAR $200 IN WILDERSWIL OR BURGLAUENEN BEATS $350 IN THE VILLAGE — the 08:00 gondola is only there to beat the midday mountain-cart queue, and a 07:35 train still has you at First by ~09:05. What you would actually lose is the Pfingstegg toboggan, the Eiger at dinner, and an unhurried morning. ❌ DO NOT solve this with an extra Rome night: arriving Sep 19 at 15:15 costs you First and Bachalpsee and a flight change, to save ~$185.", estimatedCost: "🔴 $350–500 — repriced from the real market" },
