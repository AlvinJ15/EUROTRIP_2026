...
const ITINERARY = [
  ...
  },
  {
    ...
    dayByDay: [
      ...
      { day: "Sep 19 (Sat)", plan: "🏔️ FIRST DAY — the adventure mountain. 08:00 FIRST GONDOLA, be on the first cabin. 🚶 FIRST CLIFF WALK — steel walkway bolted to a vertical cliff, ~30 min, the closest you get to the Eiger north face on foot. 🎿 FIRST FLIEGER — 800m at 84 km/h, head-first at the Eiger. 🛴 MOUNTAIN CART + TROTTIBIKE — 🔴 ride these BEFORE 10:00; by mid-day the queue reaches 110 minutes. 💧 THEN THE THING ZERMATT USED TO COST YOU: hike to BACHALPSEE, ~1h each way on an easy path from First. It is the mirror lake that reflects the Eiger, Mönch and Jungfrau — the most photographed view in Switzerland, and it is free. Back down mid-afternoon." },
      { day: "Sep 20 (Sun)", plan: "🪂 INTERLAKEN DAY — and 🧳 with no bags to move, this is now trivially easy. Train down (35 min). TANDEM PARAGLIDE FROM BEATENBERG: 20–30 min over Lake Thun and Lake Brienz with the Eiger–Mönch–Jungfrau wall behind you. ⚠️ Allow 2h–2h30 door to door: check-in 15 min · minibus up 25–30 min · briefing and wait 15–30 min · flight · landing and photos 15 min. Then choose: ⛵ LAKE BRIENZ CRUISE (turquoise glacial water, covered by the pass) or 🚡 HARDER KULM (10-min funicular to the two-lake panorama). 🍫 FUNKY CHOCOLATE CLUB in the late afternoon — make and take home your own bars. Back to Grindelwald for dinner." },
    ...
    tips: [
      ...
      "🏔️ SCHILTHORN OR JUNGFRAUJOCH — pick ONE for Sep 21. Schilthorn: 2,970m, ~CHF 54/person with the pass, a 360° revolving restaurant and roughly 200 peaks, reached through Mürren. Jungfraujoch: 3,454m, the highest railway station in Europe, an ice palace and a glacier plateau — but ~CHF 230/person even after the 25% discount, and the railway spends much of the climb inside a tunnel. ⭐ TAKE SCHILTHORN: four times cheaper, a better open panorama, and it comes with Mürren and Lauterbrunnen in the same day. Jungfraujoch is the one to save for the week-long Swiss trip.",
...
const TICKETS = [
  ...
  },
  {
    ...
    attractions: [
      ...
      { name: "❌ Jungfraujoch — skip it this trip", price: "~CHF 230/person even after the 25% pass discount", note: "🔴 The pass covers you only as far as Kleine Scheidegg or Wengen, then 25% off the top section. It is 3,454m with an ice palace and a glacier plateau, but four times the price of Schilthorn, much of the climb is inside a tunnel, and it eats the whole day. Save it for the week-long Swiss trip." },
...
const BUDGET = {
  ...
  total: { min: 14740, max: 18908, target: 15000 },
  savingTips: [
  ...
  hotelVsAirbnb: [
    ...
    { city: "Grindelwald", nights: 4, recommendation: "🆕 Guesthouse near the station — ONE base, all four nights", reason: "🆕 ZERMATT REMOVED, so the whole Swiss leg is a single base. 🧳 Bags go in on Sep 18 and come out on Sep 22 — no lockers, no mid-trip checkout, and the paraglide day stops being a logistics problem. Stay near the station: the Firstbahn base is in the village, and Interlaken, Lauterbrunnen, Mürren and Schilthorn are all day trips on the pass. ⚠️ Lauterbrunnen is the alternative worth pricing — cheaper, a 300m waterfall behind the village, and closer to Schilthorn; Grindelwald wins on the Eiger north face and having the gondola at the door.", cost: "$180–240/night" },
...
const BOOKINGS = [
  ...
  { priority: 22, what: "🏨 Grindelwald guesthouse — 4 NIGHTS, one base (Sep 18–22)", when: "1 month ahead", urgency: "high", note: "🆕 REPLACES the old Zermatt 2n + Grindelwald 2n split. 🧳 One room for four nights means the bags go in on Sep 18 and come out on Sep 22 — no lockers, no mid-trip checkout, and the paraglide day stops being a logistics problem. Stay near the station; the Firstbahn base is in the village too. ⚠️ Price Lauterbrunnen as well — cheaper, a 300m waterfall behind the village, and closer to Schilthorn. ❌ The Zermatt ski rental and Chez Vrony are gone with the ski day.", estimatedCost: "$180–240/night" },
