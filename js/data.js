...
const BUDGET = {
  ...
  total: { min: 15072, max: 18866, target: 15000 },
  savingTips: [
  ...
  hotelVsAirbnb: [
    ...
    { city: "Rome", nights: 2, firstNight: 16, recommendation: "🆕 Boutique hotel — Trastevere", reason: "🆕 DOWN FROM 3. Cutting the Vatican Museums freed the day, and the night went to Santorini. Best food neighbourhood, walkable to everything — which matters more now that Rome is arrival evening plus one full day.", cost: "$140–190/night" },
