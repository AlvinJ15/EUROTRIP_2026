...
const BUDGET = {
  categories: [
    ...
    { label: "🎫 Swiss rail — Half Fare Card + half-price tickets (×2)", min: 690, max: 800, note: "✅ THE CARDS ARE BOUGHT — $380 for the two, CHF 300. What remains in this line is half-price tickets: Geneva→Grindelwald on Sep 18, the Interlaken and Lauterbrunnen day-trip hops, and Sep 22 out to Geneva, plus the CHF 20/person GoldenPass seat reservation — about CHF 273 for the two at half fare. 🔴 REBASED FOR THE REAL EXCHANGE RATE: he paid ~1.27 USD/CHF, while this plan had been converting francs at ~1.11, so the old $610–850 was optimistic by roughly 14% rather than wrong about the francs. ✅ The pass question is settled and needs no revisiting: Half Fare Card CHF 382/person all-in, against 444 for no card and ~483 for the 4-day Travel Pass."},
  ...
  total: { min: 14872, max: 18646, target: 15000 },
  savingTips: [
