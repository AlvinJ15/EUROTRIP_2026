...
const TICKETS = [
  ...
  },
  {
    ...
    attractions: [
      ...
      { name: "🧮 Why the pass loses — the arithmetic", price: "his 5 days, per person, 2nd class", note: "Full fares: Sep 18 Geneva→Grindelwald ~78 · Sep 19 First return 43 · Sep 20 Interlaken return 23 + Brienz boat 40 · Sep 21 Lauterbrunnen return 31 + SCHILTHORN 108 · Sep 22 Grindelwald→Montreux→Geneva ~88–117 = ~CHF 411–440 discountable. 🆕 OBSERVED ON THE BOOKING PAGE: GoldenPass Interlaken Ost→Montreux showing CHF 43 in 2nd class plus CHF 20 reservation — the CHF 20 matches this plan exactly, the CHF 43 is below the ~72 assumed here. Check which it is by switching the travelcard selector to 'no discount': if it jumps to ~86 the 43 was already half fare; if it holds, either the 72 was too high or it is a Supersaver (train-specific, non-refundable — harmless here, the reservation already pins you to the 11:07, and Supersavers stack with the Half Fare Card down to ~CHF 21–25). ✅ EITHER WAY THE ANSWER HOLDS: recomputed at the worst case for the card (43 = full fare), it still wins — CHF 376/person against 431 for nothing and 483 for the 4-day pass. 🔑 THE POINT: the two big items, Schilthorn (108) and First (43), are MOUNTAIN LIFTS, and the Swiss Travel Pass discounts those 50% — the exact same 50% the Half Fare Card gives for half the price. What the pass covers 100% is the cheap stuff: Grindelwald→Interlaken is CHF 11.60. You would be paying CHF 309 to make ~CHF 175 of short trains free. 🔴 REMOVING ZERMATT IS WHAT KILLED THE PASS: Geneva→Zermatt and Zermatt→Interlaken were the two long expensive legs that justified it. ⚠️ These fares are estimates — reprice on sbb.ch. The gap is wide enough that a 20% error does not change the answer. If you swap Schilthorn for Jungfraujoch, redo this: the pass gives 25% there, not 50%." },
