...
const ITINERARY = [
  ...
  },
  {
    ...
    dayByDay: [
      ...
      { day: "Sep 19 (Sat)", plan: "🏔️ FIRST DAY, then the pool. 🧳 BEFORE YOU GO UP: pack one backpack each for tonight and leave BOTH TROLLEYS at the guesthouse — you are back there tomorrow, so they should not move at all. ✅ That is better than dropping them at the Spinne: the Spinne only has you for one night and the trolleys would have to come straight back. 08:00 FIRST GONDOLA, be on the first cabin. 🚶 FIRST CLIFF WALK — steel walkway bolted to a vertical cliff, ~30 min, the closest you get to the Eiger north face on foot. 🎿 FIRST FLIEGER — 800m at 84 km/h, head-first at the Eiger. 🛴 MOUNTAIN CART + TROTTIBIKE — 🔴 ride these BEFORE 10:00; by mid-day the queue reaches 110 minutes. 💧 THEN THE THING ZERMATT USED TO COST YOU: hike to BACHALPSEE, ~1h each way on an easy path from First. It is the mirror lake that reflects the Eiger, Mönch and Jungfrau — the most photographed view in Switzerland, and it is free. Back down mid-afternoon. 🏊 ~16:00 CHECK INTO HOTEL SPINNE (✅ booked, $544) — a 10-minute walk with just your backpacks. HEATED OUTDOOR INFINITY POOL with the Eiger straight ahead, plus whirlpool, Finnish and alpine-herb saunas, steam room and an ice Kneipp room. 🔴 The spa closes at 21:00, so this is the whole evening: you come off the mountain with wrecked legs and get into hot water looking at exactly what you just walked." },
      { day: "Sep 20 (Sun)", plan: "🪂 INTERLAKEN DAY. 🧳 Morning: check out of the Spinne (~10:00), walk your backpacks the 10 minutes back to the guesthouse, and you are whole again — the trolleys have been sitting there since Friday. Train down (35 min). ⏰ Book the paraglide for ~13:00, which leaves the Spinne checkout completely unhurried. TANDEM PARAGLIDE FROM BEATENBERG: 20–30 min over Lake Thun and Lake Brienz with the Eiger–Mönch–Jungfrau wall behind you. ⚠️ Allow 2h–2h30 door to door: check-in 15 min · minibus up 25–30 min · briefing and wait 15–30 min · flight · landing and photos 15 min. Then choose: ⛵ LAKE BRIENZ CRUISE (turquoise glacial water, covered by the pass) or 🚡 HARDER KULM (10-min funicular to the two-lake panorama). 🍫 FUNKY CHOCOLATE CLUB in the late afternoon — make and take home your own bars. Back to Grindelwald for dinner." },
...
const BUDGET = {
  ...
  total: { min: 15104, max: 19212, target: 15000 },
  savingTips: [
  ...
  hotelVsAirbnb: [
    ...
    { city: "Grindelwald — Hotel Spinne", nights: 1, recommendation: "✅ BOOKED — $544, Sat Sep 19 → Sun Sep 20", reason: "✅ PAID. Bought for one thing: the heated OUTDOOR INFINITY POOL with an unobstructed Eiger panorama, which no guesthouse in the village offers. 4★ at the foot of the north face; also whirlpool, Finnish and alpine-herb saunas, steam room, ice Kneipp room. 🔴 Spa 12:00–21:00, check-in 15:00 — which is why it lands on Sep 19: you come down from First and the Bachalpsee around 16:00 and go straight in. ⚠️ ~$334 over the nightly budget, spent knowingly.", cost: "✅ $544, paid" },
    { city: "Grindelwald — guesthouse", nights: 3, recommendation: "🆕 Guesthouse near the station — Sep 18, 20 and 21", reason: "🔴 BOOK ALL THREE NIGHTS AT THE SAME PLACE, WITH A GAP ON SEP 19 — and tell them at booking that you will leave the two trolleys with them on the night you are away. That single request is what keeps the whole leg bag-free: the trolleys never move between Sep 18 and Sep 22, and you walk to the Spinne with a backpack each. Stay near the station; the Firstbahn base is in the village, and Interlaken, Lauterbrunnen, Mürren and Schilthorn are all day trips on the pass.", cost: "$180–240/night" },
...
const BOOKINGS = [
  ...
  { priority: 22, what: "✅ DONE — Hotel Spinne Grindelwald, SAT SEP 19 (1 night)", when: "✅ Paid", urgency: "medium", note: "✅ BOOKED — $544. The heated OUTDOOR INFINITY POOL with an unobstructed Eiger panorama, which is the one thing four guesthouse nights could not buy. 🔴 SPA AND POOL OPEN 12:00–21:00 ONLY, check-in 15:00 — so it works precisely because you come down from First and the Bachalpsee around 16:00. 🧳 Take a backpack each, NOT the trolleys: those stay at the guesthouse, since you are back there on Sep 20.", estimatedCost: "✅ $544 paid" },
  { priority: 23, what: "🏨 Grindelwald guesthouse — 3 NIGHTS: Sep 18, 20 and 21 (NOT the 19th)", when: "🔴 NOW", urgency: "high", note: "🔴 BOOK ALL THREE AT THE SAME PLACE, leaving Sep 19 out — that night is the Hotel Spinne (✅ paid, $544). ⚠️ AND SAY THIS WHEN YOU BOOK: that you will leave the two trolleys with them on the night you are away. That one sentence is what keeps the whole Swiss leg bag-free — the trolleys sit still from Sep 18 to Sep 22 and you walk to the Spinne with a backpack each. Stay near the station; the Firstbahn base is in the village too. ❌ The Zermatt ski rental and Chez Vrony are gone with the ski day.", estimatedCost: "$180–240/night × 3" },
