...
const ITINERARY = [
  ...
  },
  {
    ...
    tips: [
      ...
      "🎟️ THEREFORE: BUY TWO SEPARATE 1-DAY / 1-PARK TICKETS, NOT A HOPPER. Sep 23 = Disneyland Park (already bought, with a reserved castle-show viewing spot). Sep 25 = Adventure World, €89–114/person. The hopper's whole purpose was to rescue a short second day and get you back for the castle show — you no longer need either, because the second day is full and Adventure World has Disney Cascade of Lights of its own. That saves ~€20/person.",
...
const TICKETS = [
  {
    ...
    flag: "🇫🇷",
    attractions: [
      { name: "✅ PAID — Disneyland Park, Wed Sep 23 (1 park) + reserved castle-show viewing", price: "✅ Paid — amount not recorded", note: "✅ BOUGHT: 1-park entry for two, plus the reserved viewing spot for the nighttime castle show. Tell me what it cost and the spend tracker can carry the real figure instead of an estimate." },
      ...
      { name: "❌ Park hopper upgrade — NOT NEEDED", price: "❌ saves ~€20/person", note: "❌ DON’T BUY IT. Its only purpose was to get you back into Disneyland Park for the castle show after a short second day. You already hold a reserved castle-show spot on Sep 23, and Adventure World has Disney Cascade of Lights of its own on Sep 25. Two separate 1-park tickets is cheaper AND the better structure." },
...
const SPENT = {
  updated: "Aug 3, 2026",
  items: [
    { what: "🎡 Disneyland Park, Wed Sep 23 (1 park, 2 pax) + reserved castle-show viewing", when: "Wed Sep 23", amount: null, note: "✅ BOOKED. Price not recorded here yet — send it and this becomes a real number. The reserved show spot means you do NOT need a park hopper on Sep 25." },
...
const BUDGET = {
  ...
  savingTips: [
    ...
    "🎯 IF YOU NEED TO GET BACK TOWARD $14,000, in order of least pain: drop the Segovia day trip and just do the Madrid dino museum (~$60) · Täsch instead of Zermatt village (~$80/night) · skip the chocolate workshop (~$145) · skip the Santorini caldera boat (~$100). ⚠️ Skipping the second Disney day is NO LONGER on this list: Adventure World reopened 29 Mar 2026 as a genuine full-day park with 13 attractions and its own nighttime show, so it stopped being the soft target it used to be. Not buying the hopper and not buying Premier Access Ultimate already saves you ~€40 and ~€220–460 respectively.",
