...
const TICKETS = [
  ...
  },
  {
    ...
    flag: "🇨🇭",
    attractions: [
      { name: "🎫 Half Fare Card — ⭐ RECOMMENDED", price: "CHF 120–150/person (~$133–167)", note: "🔴 THE RECOMMENDATION FLIPPED — this used to say 'the third option' under a 4-day pass marked ⭐. Priced against his ACTUAL five days it wins by roughly $200 for the two of them. All-in per person: CHF 397 versus CHF 490 for the 4-day pass, CHF 467 for buying nothing and CHF 502 for the 6-day. ⚠️ Note the 6-day pass costs MORE than carrying no card at all. 💡 Valid a whole month, 50% off nearly everything including the mountain lifts. ✅ Second, quieter advantage: it removes the Sep 18 Supersaver gamble — see the arrival row. 🔴 VERIFY the card price on sbb.ch; CHF 150 was carried here for a long time and it is likely CHF 120. Needs a passport photo and is personal, non-transferable." },
