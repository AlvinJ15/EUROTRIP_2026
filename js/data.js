...
const BUDGET = {
  ...
  total: { min: 14730, max: 19163, target: 15000 },
  savingTips: [
    ...
    "✅ $2,832 CONFIRMED PAID SO FAR: Lima↔Madrid flights $2,022 · Disneyland Park Sep 23 $213 · Barcelona Airbnb $272 · AVE $243 · Sagrada Família $82. That is ~19% of the target already committed, and the largest single item on the whole trip is now a fixed number rather than a guess.",
    "🎯 TARGET IS $15,000 WITH A CUSHION — not a hard ceiling. The floor is now $14,730 and the realistic landing zone is ~$16,500–17,000, so expect roughly $1,500–2,000 over target. That is what the cushion is for, but it is worth knowing the number honestly rather than discovering it in September. The $19,163 maximum is every category topping out at once and does not happen.",
