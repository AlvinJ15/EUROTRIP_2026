...
const ITINERARY = [
  {
    ...
    dayByDay: [
      ...
      { day: "Sep 4 (Fri)", plan: "🆕 NOT AN EVENT DAY ANY MORE — the event is Sep 5 only. Check out, metro to Sants, morning AVE → Madrid Atocha (2h30), drop the bags at the hotel in Estrecho. ⏰ TAKE THE EARLIEST TRAIN YOU CAN NOW: this became a full Madrid day, so the ~07:00 (Sants 07:00 → Atocha 09:30) buys you two extra hours of it over the 09:00. Afternoon: the centre on foot — Plaza Mayor, Puerta del Sol, Royal Palace, Retiro. 🔴 KINDERGARTEN VISITS DO NOT WORK TODAY: the Madrid school year 2026/27 starts MONDAY SEP 7 for Infantil and Primaria, so on Sep 4 the centres have no children in them. Those visits moved to Mon Sep 28, when term is three weeks old — see the Madrid final stop.", visitedOn: "Sep 4" },
      { day: "Sep 5 (Sat)", plan: "📅 YOUR MADRID EVENT — day 2, ✅ one block from the hotel. 🧳 Checkout is ~11:00 but the flight is not until 20:00, and the hotel holds bags all day (confirmed) — do NOT plan to carry them through the event. If the venue is far from the hotel, use a Bounce or Stasher point near it instead (~€2/bag). Collect by 16:30. Airport by 17:30. ✈️ 8:00pm flight Madrid→Craiova, lands ~midnight." }
    ],
    highlights: [
    ...
    tips: [
      ...
      "🆕 THE SEP 4 TRAIN — the reason changed, the answer did not. You are no longer going to the event that day (it is Sep 5 only), so nothing can make you late. But Sep 4 became a FULL Madrid day instead, so the ~07:00 departure now buys you two extra hours of it: Atocha 09:30 versus 11:30. Check which one you hold; a Renfe time change is cheap while the date is far out.",
  ...
  },
  {
    ...
    dayByDay: [
      { day: "Sep 16 (Wed)", plan: "Arrive Rome evening from Santorini. ✅ Check in ~10 min from the Vatican (booked, $308 for both nights). ⚠️ Nothing ticketed today — the flight is seasonal and this evening is the buffer. 🌃 SO THIS IS THE VATICAN EVENING, AND IT IS ALL YOU NEED THERE. Exterior only, by choice — no interior, no dome, no Sistine Chapel — which means no ticket, no queue, no dress code and no opening hours to work around. 📷 ST PETER'S SQUARE is floodlit and open around the clock, with Bernini's colonnade free of the daytime crowds. Walk out down VIA DELLA CONCILIAZIONE for the classic head-on shot with the dome centred, then ~10 min more to PONTE SANT'ANGELO — the bridge of angels over the Tiber with CASTEL SANT'ANGELO lit behind it, the best night photograph in this part of Rome. Dinner nearby. 🍝 Trastevere is a ~25 min walk from here rather than downstairs, so save it for the Sep 17 evening and make it a deliberate trip." },
      { day: "Sep 17 (Thu)", plan: "🔴 THE ONE BIG ROME DAY, and it works because the Vatican Museums are out. 🆕 THE VATICAN IS NOT ON THIS DAY AT ALL — he wants it from the OUTSIDE only, no interior and no dome, so it lives on the Sep 16 evening walk and optionally the Sep 18 dawn, both free and both needing no queue or ticket. That takes ~2h of queue-and-climb out of the one big day, which was flagged as genuinely full. ✅ SO KEEP THE EARLIEST COLOSSEUM SLOT: 09:00 COLOSSEUM + Roman Forum + Palatine Hill with the Samsung Oculus VR add-on inside the arena, and the whole day chains back from it. Lunch. 🏎️ Afternoon: Circo Massimo AR — chariot races overlaid on the real ruins. 🌆 Evening: Pantheon (€5), Piazza Navona, Trastevere for dinner, and the Trevi Fountain after dark when the crowd thins. 🦕 AND WITH ST PETER'S GONE FROM THIS DAY, the Museo Civico di Zoologia dino hall stops being an either/or with Circo Massimo — there is now room for both, and dinosaurs are down to two stops on the whole trip. 🔴 If it still overruns, the honest drop is Circo Massimo." },
      { day: "Sep 18 (Fri)", plan: "🔴 THIS ENTRY WAS STALE AND IS NOW CORRECTED — it still routed you to ZERMATT on a SWISS TRAVEL PASS, and neither exists on this trip any more. ✈️ Morning flight Rome (FCO) → Geneva (1h50), booked before ~11:00. 🚂 Then Geneva airport → Bern → Interlaken Ost → Grindelwald, ~2h35, at HALF FARE with the card (~CHF 39/person) — buy a FLEXIBLE ticket, not a Supersaver, because you are arriving off a flight and a delay would void a train-specific fare. 💡 Buy the Sep 22 tickets at the same Geneva machine while you are there and forget about them. 🗺️ NOTE THE SHAPE OF THE JOURNEY: it is ONE trip with two changes, not three trips, and INTERLAKEN IS THE SECOND-TO-LAST STOP — Grindelwald sits 34 min beyond it. 🔴 WHERE YOU GET OFF IS STILL OPEN, because Grindelwald priced at $350–500 for this night. 🅰️ STAY ON TO GRINDELWALD (~15:15, $350–500): 🛷 PFINGSTEGG TOBOGGAN — own cable car from the village, 736m run, 40 km/h, ~CHF 10, ~5 min queues — then the village under the Eiger north face, alpenglow, dinner. ⚠️ Sep 18 is the ONLY slot Pfingstegg has: Sep 19 evening is the Spinne spa and Sep 20 leaves at 08:30. 🔴 AND IT CLOSES ~17:00, so after check-in you have roughly 20 minutes of slack — a 45-min delay on a day made of one flight and three trains deletes it, and then the premium bought a dinner. 🅱️ OR GET OFF AT INTERLAKEN (~14:40, ~$200): 🚡 HARDER KULM — 10-min funicular to the two-lake panorama with the Eiger–Mönch–Jungfrau wall opposite, sunset ~19:30, and it runs into the evening so a late arrival does not kill it. 🛒 Also the COOP/MIGROS run for the week's picnics, which is the single biggest lever on the Swiss food budget. ✅ THIS IS THE RECOMMENDATION. It saves ~$150, it is robust to delay where option A is not, and it lifts Harder Kulm off Sep 20 where it never fitted. ⚠️ The price is that Sep 19 then hangs on the 07:35 train and on the Spinne taking bags at ~08:25. 🥇 BURGLAUENEN at ~$200 beats both if it exists — 12 min from Grindelwald — but there is nothing to do there that evening. 🌅 OPTIONAL BEFORE YOU LEAVE ROME, and it needs no ticket so decide it that morning: ST PETER'S SQUARE AT SUNRISE. Out at 06:15, blue hour ~06:20–06:50, sunrise ~06:55, back for the bags by 07:00. ✅ WORTH MORE THAN IT LOOKS, because the basilica FACES EAST: the rising sun hits the facade directly, and the square is genuinely empty at that hour. Sep 16 gives you it floodlit against a dark sky, this gives you warm light on the stone with nobody in frame — two different photographs, not the same one twice. ⚠️ THE COST IS A ~05:45 ALARM in front of a flight, two trains and a mountain arrival. Nothing is lost by skipping it, and since the whole Vatican stop is exterior-only there is no ticket, queue or opening time pulling you either way." }
    ],
    highlights: [
      ...
      { icon: "⛪", img: "stpeters", text: "🆕 St. Peter's FROM THE OUTSIDE — square, facade, colonnade and Ponte Sant'Angelo, by night on Sep 16 and optionally at sunrise on Sep 18. 🔄 The interior and the €10 dome climb are OUT by choice: he wants the postcard, not the tour. All of this is free, open around the clock and has no queue. 📷 The facade faces EAST, so it takes the morning sun and sits in shadow at sunset.", cost: "FREE — no ticket, no queue, no dress code" },
    ...
    tips: [
      ...
      "⛪ 🆕 THE VATICAN IS AN EXTERIOR-ONLY STOP — HE DOES NOT WANT TO GO IN. No dome climb, no basilica interior, no Sistine Chapel: he wants the classic postcard from outside, photographs and a walk around. 🔑 THAT SIMPLIFIES THE WHOLE THING, because everything he actually wants is free, open around the clock, and has no queue, no ticket and no dress code. It therefore does NOT need a slot on the busy Sep 17 — it lives on the Sep 16 arrival evening and, if he feels like it, the Sep 18 dawn. ✅ SAVES the €10/person dome climb and ~2h of queue and stairs out of the one big day. 📷 THE THREE EXTERIOR SHOTS, all within 10 min of the hotel: ST PETER'S SQUARE for Bernini's colonnade and the obelisk · VIA DELLA CONCILIAZIONE for the classic head-on approach with the dome centred · PONTE SANT'ANGELO for the angel statues over the Tiber with Castel Sant'Angelo behind. 🌅 AND THE LIGHT MATTERS HERE: the basilica FACES EAST, so the facade is lit by the MORNING sun and is in its own shadow at sunset. Sep 16 evening gives you it floodlit against a dark sky; Sep 18 at sunrise gives you direct light on the facade AND an empty square. They are different photographs, not the same one twice.",
      ...
      "Colosseum: book the guided tour WITH the VR add-on at ancientandrecent.com — you asked for the immersive stuff and this is the best of it. ✅ TAKE THE EARLIEST SLOT; the whole day chains back from it. (A previous revision moved this to ~10:00 to fit a St Peter's dome climb in front of it — that climb is off the trip, so the earliest slot is right again.)",
      ...
      "🆕 Sep 18 is a flight to Geneva. Book an FCO→GVA departure before ~11:00. 🔴 THE OLD REASON GIVEN HERE WAS ZERMATT'S SKI-RENTAL SHOPS, WHICH IS STALE — Zermatt is off the trip. The reason now is simpler and still real: Geneva→Bern→Interlaken Ost→Grindelwald is ~2h35, so an 11:00 departure lands you in the village around 15:15 with the Pfingstegg toboggan still open until ~17:00. Later and the arrival day is just a train.",
      "🆕 LEAVE ROME BY ~07:00 ON SEP 18, AND NOTE THE ROUTE CHANGED WITH THE HOTEL. The Leonardo Express advice here assumed a central base; from the Vatican, going to Termini first is a backtrack. ✅ Either check whether Rome's fixed €50 taxi fare to FCO covers your address — it is defined as inside the Aurelian Walls and the Vatican/Prati area sits outside, so confirm it rather than assume — or allow the extra 15–20 min to reach Termini by metro A. ⚠️ If you take a taxi and the fixed fare does not apply, agree the price before you get in."
    ],
  ...
  },
  {
    ...
    dailyCost: 340,
    accommodation: "🆕 TWO VILLAGES, THREE HOTELS: Grindelwald Sep 18 + 19 (arrival and the Spinne), then LAUTERBRUNNEN Sep 20 + 21 (Hotel Schützen, $555 for the pair). Grindelwald wanted ~$800 for those last two nights; Lauterbrunnen is $245 cheaper, puts you inside the valley on the day you were going to spend there anyway, and is still a village under a wall rather than a town.",
    ...
    dayByDay: [
      ...
      { day: "Sep 19 (Sat)", plan: "🏔️ FIRST DAY, then the pool. 🧳 FIRST THING: check out of last night's guesthouse and walk the two trolleys and two backpacks the ~10 min to the HOTEL SPINNE — check-in is 15:00 but reception holds luggage from the morning. You are in three different places this leg, so there is no room to come back to. Then go up empty-handed. 08:00 FIRST GONDOLA, be on the first cabin. 🚶 FIRST CLIFF WALK — steel walkway bolted to a vertical cliff, ~30 min, the closest you get to the Eiger north face on foot. 🎿 FIRST FLIEGER — 800m at 84 km/h, head-first at the Eiger. 🛴 MOUNTAIN CART + TROTTIBIKE — 🔴 ride these BEFORE 10:00; by mid-day the queue reaches 110 minutes. 💧 THEN THE THING ZERMATT USED TO COST YOU: hike to BACHALPSEE, ~1h each way on an easy path from First. It is the mirror lake that reflects the Eiger, Mönch and Jungfrau — the most photographed view in Switzerland, and it is free. Back down mid-afternoon. 🏊 ~16:00 COLLECT YOUR ROOM AT THE HOTEL SPINNE (✅ booked, $544) — the bags have been at reception since morning. HEATED OUTDOOR INFINITY POOL with the Eiger straight ahead, plus whirlpool, Finnish and alpine-herb saunas, steam room and an ice Kneipp room. 🔴 The spa closes at 21:00, so this is the whole evening: you come off the mountain with wrecked legs and get into hot water looking at exactly what you just walked." },
      { day: "Sep 20 (Sun)", plan: "🪂 INTERLAKEN DAY — 🆕 RUN EARLY, ON PURPOSE. ⏰ 08:30 check out of the Spinne · ~08:45 train · 09:30 Interlaken Ost, bags into a locker · 10:15 operator check-in · ~10:30 FLY · ~13:00 down · 14:00–15:30 chocolate · 15:45 bags out · 16:05 train · ~16:30 in Lauterbrunnen. 🔑 WHY EARLY, AND IT IS THE WHOLE POINT OF THE DAY: an earlier version booked the flight at 13:00 to keep the Spinne morning unhurried, which landed you in Lauterbrunnen at 18:45 — after dark on a valley floor with 500m walls, on the one evening you arrive there. ✅ THE MORNING WAS BUYING NOTHING: the Spinne spa does not open until 12:00, so there is no dawn swim to lose by leaving at 08:30. 🪂 AND EARLY IS BETTER FLYING: morning air over Beatenberg is calmer and less likely to be scrubbed for wind than mid-afternoon. 🧳 THE BAGS LEAVE GRINDELWALD FOR GOOD TODAY, VIA A LOCKER. Take the trolleys straight down to INTERLAKEN OST (35 min direct) and lock them there. ❌ DO NOT detour through Lauterbrunnen to drop them first: 40 min with a change at Zweilütschinen plus 20 min back out is ~60 min of travel before the flight instead of 35, and you would arrive before the 14:00 check-in anyway. 🔴 THE LOCKER IS COMPULSORY, NOT A CONVENIENCE: you BOTH fly, so nobody stays on the ground with the bags. Budget for two, go straight there on arrival, and put the camera in as well — tandem pilots shoot with their own. 💡 Ask the operator at booking whether they store bags at their office; most Interlaken ones do, and that removes the station from the day. 🪂 TANDEM PARAGLIDE FROM BEATENBERG: 20–30 min over Lake Thun and Lake Brienz with the Eiger–Mönch–Jungfrau wall behind you. ⚠️ Allow 2h–2h30 door to door: check-in 15 min · minibus up 25–30 min · briefing and wait 15–30 min · flight · landing and photos 15 min. 🍫 THEN ONE MORE THING, NOT TWO — FUNKY CHOCOLATE CLUB (~1h30, make and take home your own bars) is the pick because it is indoors, fixed-length and books ahead. ⛵ Swap it for the boat ONE WAY to Iseltwald and the train back (~1h30) if you would rather have the turquoise water, or 🚡 HARDER KULM (10-min funicular, two-lake panorama) for the view. ❌ The full Lake Brienz round trip (~2h40) does not fit any version of this day. 🏔️ ~16:30 INTO LAUTERBRUNNEN with light still in the valley — the floor will be in shadow by then, but shadow is not darkness, and you get the Staubbach and the village properly instead of a black wall. ⚠️ If the operator cannot fly you before ~11:30, drop the chocolate rather than the daylight." },
      { day: "Sep 21 (Mon)", plan: "🏔️ LAUTERBRUNNEN VALLEY + SCHILTHORN — the day the Zermatt version had no room for. 🆕 NO TRAIN AT ALL — YOU WAKE UP IN LAUTERBRUNNEN. This day used to open with ~40 min and a change at Zweilütschinen from Grindelwald, and ~80 min round trip is simply deleted. Walk out of the hotel into it: 72 waterfalls, and STAUBBACH drops 300m off a vertical wall right behind the village, free from the street. 💧 TRÜMMELBACH FALLS (~CHF 14) — glacier meltwater carved INSIDE the mountain, lift-accessed. Then cable car up via Mürren — a car-free village pinned to a cliff with no access road — to 🏔️ SCHILTHORN / PIZ GLORIA, 2,970m: a 360° revolving restaurant, a James Bond filming location, and a panorama of roughly 200 peaks that many rate the best single view in the region. 🎫 50% off with the Swiss Travel Pass. ☁️ WEATHER PLAN B: low cloud turns Schilthorn into CHF 108 of fog. Drop the summit and keep the valley — Lauterbrunnen, Trümmelbach and Mürren all work without a clear sky. ⚠️ ALTERNATIVE: swap this for JUNGFRAUJOCH, the 'Top of Europe' at 3,454m — see the tips for which one to pick." },
      { day: "Sep 22 (Tue)", plan: "🚞 GOLDENPASS DAY. 🆕 AN EASY MORNING: check out of Lauterbrunnen around 10:00 and take the 20-min train to Interlaken Ost, comfortably ahead of the 11:07. The old Grindelwald plan needed a 09:37 with all the luggage. 🚞 GOLDENPASS EXPRESS — take the 11:07 now that the chocolate workshop moved to Sunday: gauge-changing panoramic coaches over the Simmental, opening onto Lake Geneva. Montreux ~14:25 → Geneva ~15:40 → TGV Lyria → PARIS GARE DE LYON ~19:30, which leaves you an evening in the Marais instead of a midnight arrival. The 14:07 remains the fallback (Paris ~22:00). ❌ The 16:07 still does not work — Montreux ~19:20, after the last TGV out of Geneva." }
    ],
    highlights: [
      { icon: "🪂", img: "paragliding", text: "TANDEM PARAGLIDE FROM BEATENBERG — Sun Sep 20, 🆕 BOOK THE ~10:30 SLOT, not the afternoon: calmer air, less wind-cancellation risk, and it is what gets you into Lauterbrunnen with daylight left. 20–30 min over Lake Thun and Lake Brienz with the Jungfrau massif behind. The green-and-turquoise Switzerland you actually pictured. Chosen over the Grindelwald First flight, which launches higher at the Eiger north face but has no lakes and costs ~CHF 50/person more.", cost: "~CHF 180–190/person" },
    ...
    tips: [
      ...
      "🏨 🆕 TWO VILLAGES: GRINDELWALD SEP 18–20, LAUTERBRUNNEN SEP 20–22. 🔴 THIS REVERSES EARLIER ADVICE IN THIS PLAN — TWICE, and the reasoning is worth keeping visible. (1) The plan first said keep all four nights in Grindelwald, because moving them would save only $40–80. That estimate was generic and wrong: real quotes came back at ~$800 for the two nights in Grindelwald against ~$400 in Interlaken, and the cheap Grindelwald listings were hostels and shared rooms. The original recommendation was built on itinerary logic and never tested against the market, which is the actual mistake. (2) So it moved to Interlaken on price — but Interlaken is a resort town on a flat plain between two lakes, not a village under a mountain, and the postcard was the whole point. ✅ LAUTERBRUNNEN IS THE ANSWER TO BOTH: Hotel Schützen at $555 for the two nights, $245 under Grindelwald, in a village on a valley floor with 500m walls either side and the Staubbach dropping 300m behind the houses. ✅ SEP 18 AND 19 STAY IN GRINDELWALD AND ARE NOT NEGOTIABLE: the Spinne is paid, and Sep 19 starts on the 08:00 First gondola, which only works from the village. ✅ SEP 21 IS THE LAUTERBRUNNEN DAY, so it now opens with no train at all — ~80 min of round trip deleted. 🧳 One bag-move, on Sep 20, and it routes through an Interlaken Ost locker rather than a detour — see the luggage plan. 🏔️ MÜRREN is the prettiest village of all (car-free, on a cliff shelf facing the Eiger–Mönch–Jungfrau, sunlit all day) but is reachable only by cable car, so two trolleys make it a bad base. Have lunch there on Sep 21 instead.",
  ...
  },
  {
    ...
    dayByDay: [
      ...
      { day: "Sep 28 (Mon)", plan: "🆕 SCHOOL-VISIT DAY — this is why Sep 28 is a Monday worth having. The Madrid school year started Sep 7, so by now term is three weeks old and centres are running normally: exactly what Sep 4 could not offer. 🏫 VISIT EARLY-YEARS SCHOOLS to see how they work and what classroom technology they use. 🔴 ARRANGE THIS WEEKS AHEAD BY EMAIL — child-safeguarding rules mean no centre lets a visitor walk in. International and private schools accept foreign visitors far more readily than public ones (public centres need Consejería authorisation and rarely grant it to individuals), and they tend to have more of the technology you are curious about. Mornings are the working part of the day, so aim for ~09:30–12:30. 🦕 Afternoon: Museo Nacional de Ciencias Naturales (~€7) — full Diplodocus and the original Megatherium, one of only two dinosaur stops left on the trip. ⚠️ Segovia now competes with the school visits for this day; if the visits come through, drop Segovia. Repack properly, early night.", visitedOn: "Sep 28" },
...
const TICKETS = [
  ...
  },
  {
    ...
    flag: "🇨🇭",
    attractions: [
      { name: "🎫 Swiss Half Fare Card — ⭐ RECOMMENDED", price: "CHF 150/person — CHF 300 for the two of you", note: "✅ PRICE CONFIRMED ON sbb.ch AT CHF 150. An earlier note here guessed CHF 120 and was wrong; the CHF 150 this plan carried all along was right. The recommendation is unaffected — the comparison below always used 150. 📅 Validity 1 month, and its length is irrelevant: what decides this is whether the 50% saved beats CHF 150, not how many days the card is alive. 💰 ALL-IN PER PERSON: CHF 397 with the card · 467 with nothing · 490 with the 4-day Travel Pass · 502 with the 6-day. So it saves ~CHF 93/person against the pass, but only ~CHF 70 against carrying nothing at all. 🔴 BREAK-EVEN IS CHF 300 OF DISCOUNTABLE SPEND, and he is at ~440 — the margin rests almost entirely on SCHILTHORN (CHF 108). Drop Schilthorn on Sep 21 for weather or a closed lift and the saving collapses to ~CHF 16/person, near enough a wash. Swap it for Jungfraujoch, which costs more, and the card gets better. ⏳ WAITING IS OPTIONAL, NOT PROTECTIVE — a correction to an earlier version of this note, which said to hold off until Sep 21 was decided. Priced out, the downside barely exists: full plan saves CHF 70/person, without Schilthorn CHF 16, and only in the extreme case of dropping Schilthorn AND the Brienz boat AND Harder Kulm does it turn negative, by CHF 4. Waiting optimises the margin; it does not protect you. ✅ AND THE GOLDENPASS SETTLES IT ANYWAY: there is no reservation-only product, so the cards have to come first regardless. Buy both now, then book the train and declare the discount. The card is a tariff, not a seat — it never sells out and the price holds until the January revision, so either order is safe. 🔴 BUY TWO. It is personal and non-transferable, and sbb.ch defaults the panel to 1x. Set travellers to 2 and the start date to Sep 18, 2026. Sold only to people resident outside Switzerland and Liechtenstein, which he is." },
      { name: "🔴 DO NOT BUY THE 'HALBTAX-ABO' — WRONG PRODUCT", price: "CHF 190/YEAR — not the CHF 120/month card you want", note: "He went to sbb.ch and landed on this; the names are nearly identical and one is a trap. HALBTAX-ABO is the SWISS RESIDENT subscription: CHF 190, valid TWELVE MONTHS, and issued on a SwissPass card POSTED TO A SWISS ADDRESS — which he does not have. The 'Treuerabatt' it offers is a loyalty discount for renewing a GA, meaningless to a visitor. What he wants is the SWISS HALF FARE CARD: ~CHF 120, valid ONE MONTH, digital, tied to a passport, sold through Swiss Travel System (sbb.ch/en visitor offers, or MySwitzerland). 🔴 AND THE DATE: sbb.ch defaulted the start to the day he was browsing. The card lasts ONE MONTH — bought in mid-August it expires BEFORE Sep 18 and buys nothing. SET VALIDITY TO START SEP 18, 2026. Do not buy it early to get it out of the way. ℹ️ The page is in German because sbb.ch defaults to German; the DE/FR/IT/EN switch is top right, or use sbb.ch/en. ✅ Reassurance: even at the wrong CHF 190 it still beats the 4-day Travel Pass (CHF 437 vs 490/person), so the recommendation holds either way — he would simply be paying CHF 70/person too much and waiting on Swiss post." },
      { name: "🧮 Why the pass loses — the arithmetic", price: "his 5 days, per person, 2nd class", note: "Full fares: Sep 18 Geneva→Grindelwald ~78 · Sep 19 First return 43 · Sep 20 Interlaken return 23 + Brienz boat 40 · Sep 21 Lauterbrunnen return 31 + SCHILTHORN 108 · Sep 22 ~101 (Grindelwald→Interlaken ~12 + Interlaken→Montreux 56 CONFIRMED ON SBB + Montreux→Geneva ~33) = ~CHF 424 discountable. 🔑 THE POINT: the two big items, Schilthorn (108) and First (43), are MOUNTAIN LIFTS, which the Swiss Travel Pass discounts 50% — the same 50% the Half Fare Card gives for half the price. What the pass covers 100% is the cheap stuff: Grindelwald→Interlaken is CHF 11.60. 💰 ALL-IN: CHF 382/person with the card · 444 with nothing · ~483 with the 4-day pass. 🔴 REMOVING ZERMATT IS WHAT KILLED THE PASS: Geneva→Zermatt and Zermatt→Interlaken were the long expensive legs that justified it. ✅ SBB CONFIRMED Interlaken Ost→Montreux at CHF 56 marked 'No discount' — so that is full fare, CHF 28 with the card, and the CHF 43 seen earlier was not a half fare. ⚠️ If you swap Schilthorn for Jungfraujoch, redo this: the pass gives 25% there, not 50%." },
      { name: "🎫 Swiss Travel Pass — 4 days (rejected)", price: "CHF 309/person (~$344)", note: "There is NO 5-day pass; durations are 3/4/6/8/15 days (CHF 254/309/399/439/499, 2nd class). Best play would be activating Sep 19 and paying the Sep 18 arrival separately — ~CHF 490/person all-in. ✅ WHAT IT GIVES THAT THE HALF FARE CARD DOES NOT: trains, buses and boats at 100% instead of 50% (the Brienz cruise goes from free to ~CHF 20), free entry to 500+ museums, and no ticket-buying. 🔴 The museums are worth nothing to him — he has said plainly that old things and statues do not interest him — which is most of the pass's advertised value gone." },
      { name: "🎫 Swiss Travel Pass — 6 days (rejected)", price: "CHF 399/person (~$444)", note: "Activate Sep 18 and everything is covered with nothing to think about — but at ~CHF 502/person all-in it is the most expensive option on this list, dearer than travelling with no card whatsoever. Simplicity, priced." },
      { name: "🚂 Geneva → Interlaken Ost (Sep 18 arrival)", price: "~CHF 60–72/person full fare", note: "🔴 THE SUPERSAVER TRAP — this is the second reason the Half Fare Card wins. A Supersaver at CHF 30–45 is tied to ONE named train and is non-refundable, non-changeable. You reach Geneva on a flight from Rome that morning. A delay and the ticket is gone. With the Half Fare Card you buy a flexible ticket at ~CHF 39 and the risk does not exist." },
      ...
      { name: "🧀 WEATHER PLAN B — Alpkäsefest, Grosse Scheidegg, SAT SEP 19", price: "bus Grindelwald↔Grosse Scheidegg, ~50% off with the Half Fare Card", note: "✅ CONFIRMED BY THE ORGANISER (bergschaft-scheidegg.ch): Saturday 19 September 2026, 10:00–17:00, live music 12:00–17:00, 32nd edition, up at Grosse Scheidegg above Grindelwald — decorated Spycher huts open, Mutschli, fresh and aged alpine cheese, alp butter, zopf, preserves, food and drink at every hut. 5 dairies summer 164 cows and one summers 96 goats up there. 🎁 Buy the Grindelwald–Grosse Scheidegg RETURN on the day and you get a voucher for alp products. ~35–40 min by bus from the village. 🔴 DO NOT FORCE IT INTO THE PLAN. Sep 19 is already the fullest day of the leg — bags to the Spinne, 08:00 First gondola, carts and zipline before 10:00, Bachalpsee, then the spa from 16:00. Squeezing the festival in costs you an unhurried Bachalpsee, which is the best photograph of the whole trip. ☁️ USE IT AS THE BAD-WEATHER SWAP INSTEAD. Check the forecast on the evening of Sep 18: if Sep 19 is clouded in, First and Bachalpsee are worthless — no panorama without visibility, no mirror reflection without sun — and this is a FESTIVAL, not a viewpoint, so it works in fog. The Spinne spa still opens at 16:00 either way. ⚠️ NOT the cow parade. That is the ALPABZUG, and its date is genuinely unpublished — the Bergschaft's own agenda reads 'Mit den Kühen am … September 2026' with the day left blank, because it is set days-to-weeks ahead on the weather. Usually mid-September, so Sep 18–22 is on the edge and not ruled out. 📧 Email Grindelwald tourism in early September and ask about the Alpabzug (the Bussalp→village one is the good one). Costs an email; a bonus if it lands, nothing lost if not." },
      { name: "🎟️ Sep 22 — buy POINT-TO-POINT at CHF 28, not the Saver Day Pass", price: "~CHF 48.50/person in singles vs CHF 49 day pass, with the card", note: "🔴 FIRST, THE THING THE SBB SCREEN DOES NOT SAY: none of the four offers it shows is the SEAT RESERVATION. They are all base fare only. The GoldenPass Express reservation is mandatory, ~CHF 20/person, bought separately, discounted by no card — and it is the ONLY item here with a quota. These tickets cannot sell out and can be bought from a machine on the morning itself; the reservation can. Do not buy any of them before the reservation is secured. 🔴 AND A CORRECTION TO AN EARLIER VERSION OF THIS ENTRY, which claimed the Saver Day Pass saved ~CHF 40/person. That was true WITHOUT the Half Fare Card. With it the advantage collapses: the card halves the singles, but the day pass only falls from CHF 61 to 49. 🆕 REPRICED FROM LAUTERBRUNNEN, which is now the Sep 21 base: Lauterbrunnen→Interlaken Ost ~4 + Interlaken Ost→Montreux 28.00 (SBB-confirmed, exactly half of 56) + Montreux→Geneva ~16.50 = ~CHF 48.50, against CHF 49 for the Saver Day Pass. Half a franc — a dead heat, so the tiebreaker is flexibility, and the day pass is the non-refundable one while the GoldenPass reservation is still unbought. ✅ TAKE THE SINGLES: same money, and they stay flexible while a Saver Day Pass is non-refundable and locked to the date. ⚠️ The two outer legs are estimates — price them with the card applied and if they push the total past CHF 49, switch to the day pass. 📖 WHAT THE FOUR OPTIONS ARE: Point-to-point = one journey A to B, and Sep 22 is THREE journeys so it covers only the middle one. City-Ticket (CHF 32.80) adds urban transport in Montreux, where he only changes platforms. Saver Day Pass (49) = whole network for the day, demand-priced, non-refundable. Day Pass for the Half Fare Travelcard (78) = the same but fully flexible at a fixed price. ✅ AND IT SETTLES THE CARD: CHF 56 became CHF 28 the moment he declared it. This single leg is already a third of the card's price back." },
      { name: "✅ GoldenPass Express — BOUGHT, ticket + reservation", price: "✅ PAID: CHF 20 reservation + CHF 28 ticket each, CHF 96 for two, $120", note: "✅ Tue Sep 22, the 11:07 from Interlaken Ost, 2nd class, via Zweisimmen — done, and it was the last item in Switzerland that could sell out. The reservation came in at the bottom of the CHF 20–35 range carried here. Kept below: the reasoning, because it explains the whole product and is worth re-reading before boarding. 🔑 THE TICKET IS TWO SEPARATE THINGS AND THEY BEHAVE OPPOSITELY. (1) THE SEAT RESERVATION: mandatory on the panoramic coaches, a FLAT supplement, and NO card touches it — not the Half Fare Card, not the Swiss Travel Pass. You do not need to own any card to book it, and owning one saves you nothing on it. It DOES sell out, so buy it today. (2) THE BASE FARE: this is where the cards work — 50% off with the Half Fare Card, 100% covered by the Swiss Travel Pass. Buy it later, once the card is sorted. ✅ CLEANEST ORDER: buy the Half Fare Card first with validity starting SEP 18 (you can buy it today for a future start date), then book the reservation and the half-price base fare in the same sbb.ch transaction. 🛒 WHERE, AND WHICH BUTTON: gpx.swiss (operator, MOB) or sbb.ch/en. 🔴 CORRECTION — an earlier version of this note said gpx.swiss sells the reservation ON ITS OWN. It does not appear to: the options there are 'GoldenPass Express (1st & 2nd cl.)', 'Prestige', 'Ticket (without reservation)', groups and giftcards, and none of them is reservation-only. ✅ PICK 'GoldenPass Express (1st & 2nd cl.)' and choose 2nd class — that is ticket PLUS the mandatory reservation. ❌ NOT 'Ticket (without reservation)' — that leaves you without the seat, which is compulsory on this train. ❌ Not Prestige unless you price it and want it: it is the premium class above 1st, rotating armchairs in the nose of the train with a forward panoramic view. The ordinary panoramic coaches already have floor-to-ceiling glass. 🔑 SO THE ORDER IS FORCED: buy the two Half Fare Cards FIRST, then book here and declare the card at the discount step. Booking before you hold it means full base fare and ~CHF 36/person wasted. 💡 Being tied to the 11:07 costs you nothing here — the reservation already pins you to that train, so a train-specific advance fare carries no extra risk on this leg, unlike the Sep 18 arrival." },
...
const DINING = [
  ...
  { name: "🆕 Piz Gloria, Schilthorn — the revolving restaurant at 2,970m", city: "Lauterbrunnen, Switzerland", location: "Schilthorn summit, reached by cable car via Mürren", image: "https://images.unsplash.com/photo-1531366936337-7c912a4589a7?w=600&q=80", stars: 0, pricePerPerson: "CHF 30–42 (~$38–52)", totalFor2: "~$75–105", description: "🆕 ADDED — it was in the plan as a place to stand and never as a meal to pay for. A restaurant that rotates a full turn while you eat, 360° over roughly 200 peaks, and the James Bond location. 🔑 THE HONEST CASE FOR IT: you are paying for the room, not the plate — the food is competent, the window is the point, and no other lunch on this trip is at 2,970m. 🔴 SO MAKE IT THE ONLY RESTAURANT MEAL ON SEP 21, and picnic the rest of the Swiss days. ☁️ Worthless in cloud, like the summit itself — check the webcam that morning.", mustBook: false, bookingNote: "No booking needed; it seats a lot. ⚠️ Comes on top of the ~CHF 108 lift fare (half price with your card), which is the real cost of being up there. Swiss restaurant prices with a mountain premium — a beer is CHF 8.", priority: 3 },
...
const SPENT = {
  ...
  items: [
    ...
    { what: "🏨 Madrid hotel, 1 night — Estrecho, one block from the event", when: "Fri Sep 4 → Sat Sep 5", amount: 150, note: "Double room, 16 m², air conditioning, one block from Estrecho station and therefore from the Sep 5 event venue. Room only — the +$14 continental breakfast was skipped in favour of a neighbourhood bar (tostada con tomate and coffee runs €3–4.50pp in a barrio like this). ✅ They hold luggage all day after checkout, which is what Sep 5 depends on. Top of the $120–150 budget, and the location earns it: the event runs Sep 5 and this removes every transfer." },
    ...
    { what: "🎫 2× Swiss Half Fare Card — the Swiss transport decision, settled", when: "Valid Sep 18 → Oct 18", amount: 380, note: "CHF 150 each, CHF 300 for the two. ✅ Chosen over the 4-day Swiss Travel Pass, which priced out ~CHF 93/person WORSE across his actual five days — a pass earns its keep on long trains, but his big Swiss items are mountain LIFTS (Schilthorn 108, First 43) that it discounts 50%, exactly what the card gives for half the price. 💱 THE FX LESSON: $380 for CHF 300 is an effective ~1.27 USD/CHF. Swiss figures elsewhere in this plan were converted at ~1.11, so EVERY dollar amount for Switzerland is understated by roughly 14%. Trust the CHF numbers, not the dollar ones. 🔴 Still to buy: the GoldenPass seat reservation (~CHF 20/person — the only thing in Switzerland that sells out) and the Interlaken Ost→Montreux ticket at CHF 28, which has no quota and can be bought at a machine on the morning of Sep 22." },
    { what: "🎡 Disney Adventure World, Fri Sep 25 (2 pax) — the second Disney day", when: "Fri Sep 25", amount: 164, note: "✅ CONFIRMED AS ADVENTURE WORLD, which is what the plan needed — Sep 23 covers Disneyland Park and its castle show, and because the two nighttime shows run simultaneously, only a second park gets you the second show. $82/person, UNDER the $194–248 estimated: cheaper than the Sep 23 day because there is no reserved show viewing on this one. 🎢 Both Disney days are now ticketed and nothing in the Paris block can sell out. ⏰ Rope drop 09:30 — Frozen Ever After first, Crush's Coaster second. ❌ No hopper, no Premier Access Ultimate; a single-ride Premier Access for Frozen is the only one worth deciding, that morning, in the app." },
    { what: "🏔️ Hotel Schützen, Lauterbrunnen — 2 nights, the Swiss base question settled", when: "Sun Sep 20 → Tue Sep 22 · check-in 14:00", amount: 568, note: "✅ BOOKED at $568 for the pair, $13 over the $555 quoted. 🔁 THIS SLOT CHANGED HANDS TWICE AND THE HISTORY IS THE USEFUL PART. It began as Grindelwald on itinerary logic — one base, no bag moves — at an ESTIMATED $150–240/night that was never checked against the market. Real Grindelwald came back at ~$800 for these two nights, so it moved to Interlaken at ~$400. But Interlaken is a resort town on a flat plain, and the whole reason for coming was a village under a wall. Lauterbrunnen at $568 is the answer to both: $232 under real Grindelwald, $168 over Interlaken, and it is a village on a valley floor with 500m walls either side and the Staubbach dropping 300m behind the houses. 💰 The lesson worth keeping: the plan's estimate was wrong by nearly half, and only a real quote exposed it — every remaining unbooked stay carries the same risk. ✅ AND IT PAYS IN TIME: Sep 21 is the Lauterbrunnen day, so it now opens with no train at all — ~80 min of round trip from Grindelwald deleted — and Sep 22 is a 20-min hop to the GoldenPass. 🕑 Check-in 14:00, which never binds: Sep 20 has you flying at midday and arriving ~16:30." },
    { what: "🚞 GoldenPass Express — ticket + mandatory seat reservation (2 pax)", when: "Tue Sep 22, 11:07 Interlaken Ost → Montreux", amount: 120, note: "✅ CHF 20 reservation + CHF 28 half-fare ticket each = CHF 96 for the two, $120. 2nd class, via Zweisimmen. 🔑 THE LAST SCARCE THING IN SWITZERLAND IS NOW SECURED. The reservation is compulsory on the panoramic coaches, is a flat supplement no card discounts, and is the only Swiss item on this trip with a quota — everything still unbought (the Sep 18 arrival, the day hops, Montreux→Geneva) has no quota at all and can come from a machine on the day. 💳 THE CARD PAID FOR ITSELF FASTEST HERE: the full fare on this leg is CHF 56, so CHF 28 saved per person on one journey is over a third of the card's CHF 150 back in a single ride. 🎫 The four SBB offers on this route were base fare only, and picking Point-to-point at 28 over City-Ticket at 32.80 saved CHF 4.80/person for urban transport in Montreux, where you only change platforms. 💱 FX CHECK: $120 for CHF 96 is 1.25 USD/CHF — the second independent confirmation, after the cards at 1.27, that the ~1.11 used across this plan's Swiss dollar figures is too optimistic by roughly 13%." },
    { what: "🏛️ Rome hotel, 2 nights — ~10 min walk from the Vatican", when: "Wed Sep 16 → Fri Sep 18", amount: 308, note: "✅ $154/night against a $140–190 estimate — INSIDE PLAN and near the bottom of it, which is worth noting after Grindelwald broke the same kind of estimate twice. 🔄 NOT the Trastevere this plan recommended, and that is fine, but it reorders Sep 17. ⛪ THE VATICAN IS 10 MINUTES ON FOOT AND HE WANTS IT EXTERIOR-ONLY — the postcard, not the tour. No interior, no €10 dome, no Sistine Chapel. So it costs nothing, queues for nothing and needs no slot on the busy Sep 17: it goes on the Sep 16 arrival evening (floodlit square, Via della Conciliazione, Ponte Sant'Angelo) and optionally at Sep 18 sunrise, when the east-facing facade takes direct light and the square is empty. ⚠️ THE TRADE: Trastevere dinner is now a ~25 min walk rather than downstairs, and the Colosseum, Forum and Pantheon are 25–40 min out. ✈️ And the plan's 'Leonardo Express from Termini' on Sep 18 assumed a central hotel — from here that is a backtrack, so confirm whether Rome's fixed €50 airport taxi fare reaches your address (it applies inside the Aurelian Walls; Prati/Vatican is outside) before relying on it." },
  ],
  note: "✅ Every committed booking carries a real figure again — nothing sits in the 'booked but unpriced' column. The confirmed total is a complete picture of money already spent, not a floor."
};
...
const BUDGET = {
  categories: [
    ...
    { label: "Accommodation (27 nights, 2 pax)", min: 4482, max: 5432, note: "✅ ROME IS BOOKED at $308 for two nights, $154/night against a $140–190 estimate — the first stay in a while to land inside plan, which takes $72 off this line's ceiling. 🔴 SEP 18 IN GRINDELWALD REPRICED FROM $150–240 TO $350–500, THE REAL MARKET — +$200 on the minimum, and it pushes this trip's floor past the $15,000 target for the first time. That is not a decision that has been taken, it is an estimate being corrected: the money was always going to be this, the plan just did not know. See the booking entry for the alternatives (Wilderswil and the small halts down the line at ~$200, or paying it to protect the Sep 19 First morning). ✅ LAUTERBRUNNEN IS BOOKED — Hotel Schützen, $568 PAID for Sep 20 + 21, replacing a $150–240/night estimate. 🔴 READ THE SIGN CAREFULLY: this line goes UP by $368 on the minimum, and that is not a cost increase, it is the paper plan meeting reality. The old Grindelwald figure was an estimate; the real quote there was ~$800 for the same two nights, so against what he would actually have paid this SAVES $232. 💰 THE THREE-WAY: Grindelwald ~$800 · Lauterbrunnen $568 · Interlaken ~$400. He is paying $168 over the cheapest for a village under a 500m wall instead of a resort town on a plain — a deliberate buy, like the Spinne, not a slip. Swiss leg now $1,262–1,352 against a real-market Grindelwald $1,494–1,584. 🔴 THE WARNING THIS LEAVES BEHIND: 9 stays are still unbooked on estimates that have never been tested. Grindelwald's was wrong by nearly half. Price the expensive ones — Santorini, Cappadocia, Paris — before trusting these ranges. ✅ HOTEL SPINNE IS PAID: ✅ HOTEL SPINNE IS PAID: $544 for Sep 19, the one night with an outdoor infinity pool facing the Eiger. That is 2.3–3× the $180–240 nightly budget for this leg, spent knowingly on ONE night rather than spread over four. 🆕 Grindelwald is now three separate stays (Sep 18 · Spinne Sep 19 · Sep 20–22), and the floor on the other three dropped to $150 because going cheaper there is the easiest way to offset it. Swiss leg: $1,024–1,264 against $720–960 budgeted. ✅ BARCELONA IS PAID: $272 for both nights, i.e. $136/night against a $140–180 estimate — the first booking to come in UNDER plan (min −$8, max −$88). 🆕 LONDON'S 2 NIGHTS ($360–460) CAME OUT and were redistributed: Santorini +1 ($220–300), Grindelwald +1 ($180–240), Madrid-end +1 ($110–150), Rome −1 (−$140–190). Net roughly +$10–40 — the two extra experience nights are essentially free because London paid for them. 🆕 ZERMATT REMOVED: its 2 nights at $230–290 became 2 more Grindelwald nights at $180–240, saving ~$100–100 and collapsing the Swiss leg to a single base. Santorini is now the most expensive bed on the trip." },
    { label: "🍽️ Food (28 days) — ALL meals, BOTH of you", min: 2040, max: 2900, note: "✅ YES, FOOD IS IN THIS BUDGET AND IT IS THIS LINE. It covers every breakfast, lunch and dinner for the two of you across all 28 days — it is not an extra to add on top of the total. That works out at $73–104 a day for two. 🔴 THE ONE CARVE-OUT, so nothing is counted twice: Le Jules Verne ($705, Sep 24) sits on its OWN line below and is already paid. Everything else you eat that day still comes out of here. 🍾 AND THE OTHER NAMED RESTAURANTS ARE *NOT* SEPARATELY BUDGETED — the Oia caldera dinner, the Sultanahmet rooftop, Trastevere, Piz Gloria at the Schilthorn summit and San Miguel all come out of THIS line. Each one costs roughly a whole mid-tier day's food in a single sitting (Oia is 136% of one, Istanbul 125%, Rome 100%). Together they ADD about $200 over ordinary days, against $385 of headroom between mid-tier eating and this line's ceiling — so they fit, with ~$185 spare. 🔴 But that is the SAME headroom that pays for eating comfortably on normal days: you can have the special dinners or a relaxed margin everywhere else, not both. 📊 SEE THE FOOD SECTION for the per-country daily rates — Romania at $50/day and Switzerland at $145/day are not the same trip, and a single average hides that. Summed properly, eating lean the whole way is ~$1,555 and eating mid the whole way is ~$2,515, so this line sits between them: it assumes you eat cheaply on the cheap legs and properly on the expensive ones. 🆕 −$80–120 earlier: two London days at London prices became Madrid days at Madrid prices. 💡 The two levers that actually move it are the Paris apartment kitchen and Swiss supermarket lunches." },
    ...
    { label: "Activities (Disney ×2 days, Colosseum VR, Toledo, Segovia, Acropolis, Göreme, Hagia Sophia…)", min: 1591, max: 2185, note: "🆕 ST PETER'S DOME CLIMB REMOVED, −$22 (€10/person): the Vatican is now an exterior-only stop by choice — the square, the facade and the photographs, with no interior and no Sistine Chapel. Everything he wants there is free, so the whole Vatican now costs $0 and takes no slot on Sep 17. ✅ DISNEY SEP 23 IS PAID: $213 for two ($160 entry + ~$53 reserved castle-show viewing). ✅ DISNEY SEP 25 IS ALSO PAID: $164 for two at Adventure World, under the $194–248 estimated. Both Disney days are now real numbers — two 1-park tickets, $213 + $164 = $377 total, against ~$370–457 for the 2-day hopper this replaced. So the hopper was never the saving it looked like. ✅ SAGRADA FAMÍLIA IS PAID: $82 for 2, replacing a $56–95 estimate (min +$26, max −$13). Vatican Museums removed (−$48 for 2). Santorini caldera boat (+$80–130), Toledo and Segovia AVE + entries (+$120–160), the two dinosaur museums (+$35), Trümmelbach Falls (+$32). Warner Bros and the Tower of London are gone with London." },
    ...
    { label: "🎫 Swiss rail — Half Fare Card + half-price tickets (×2)", min: 690, max: 760, note: "✅ $500 OF THIS LINE IS NOW PAID AND FIXED: $380 for the two Half Fare Cards and $120 for the GoldenPass (CHF 20 reservation + CHF 28 ticket each). 🔴 THE MAX COMES DOWN $40 because the two live uncertainties are gone — the reservation was carried at CHF 20–35 and landed at 20, and the Interlaken→Montreux fare was carried at ~72 and landed at 56 full / 28 with the card. ⚪ WHAT IS LEFT, roughly $174 for the two: Sep 18 Geneva→Grindelwald (~CHF 39/person flexible), the Sep 20 hops down to Interlaken and up to Lauterbrunnen (~CHF 10/person), and on Sep 22 Lauterbrunnen→Interlaken Ost plus Montreux→Geneva (~CHF 20.50/person). None of it can sell out, so it is all machine-on-the-day. 💱 REBASED FOR THE REAL EXCHANGE RATE, now confirmed twice: the cards charged at 1.27 USD/CHF and the GoldenPass at 1.25, while this plan converts francs at ~1.11 — so the old $610–850 was optimistic by ~13%, not wrong about the francs. ✅ The pass question is settled and needs no revisiting: Half Fare Card CHF 382/person all-in, against 444 for no card and ~483 for the 4-day Travel Pass."},
  ...
  total: { min: 15078, max: 18772, target: 15000 },
  savingTips: [
    ...
    "✅ $4,446 CONFIRMED PAID — AND EVERY COMMITTED BOOKING NOW HAS A REAL FIGURE: Lima↔Madrid flights $2,022 · Le Jules Verne $705 · 🆕 Hotel Spinne $544 · Barcelona Airbnb $272 · 🆕 Madrid hotel $150 · AVE $243 · Madrid→Craiova $215 · Disneyland Park Sep 23 $213 · Sagrada Família $82. That is 30% of the target, and there is nothing left in the 'booked but unpriced' column — the number you see is the number you have spent.",
    "🎯 TARGET IS $15,000 WITH A CUSHION — not a hard ceiling. ✅ THE FLOOR IS UNDER IT: $14,724. Building the per-city lodging table exposed that the accommodation line had drifted $350–520 above the sum of its own rows across many edits — corrected, and the correction more than absorbed the Spinne night. Realistic landing ~$16,200–16,900, ceiling $18,692 (every category topping out at once, which does not happen). Expect roughly $1,400–2,000 into the cushion. ✅ With 25% of the trip paid and every committed figure known, that estimate is now built on real prices for the biggest lines rather than guesses — it will not swing much further.",
  ...
  // `firstNight` is the day of September you first SLEEP here. Combined with
  // `nights` it gives the calendar the exact nights each stay covers, which is
  // what drives the 🏠/🏚️ booked-or-not marker on every day cell. A stay is
  // treated as booked when its `cost` carries a ✅ — same convention the spend
  // tracker uses, so there is one source of truth and not two.
  hotelVsAirbnb: [
    { city: "Barcelona", nights: 2, firstNight: 2, recommendation: "✅ BOOKED — Airbnb, Gothic Quarter near the Cathedral", reason: "✅ PAID: $272 for both nights ($136/night, under the estimate). Same place both nights, which is what makes Sep 3 a bag-free day. The Gothic Quarter is better than the Eixample for how this day actually runs: the Cathedral, La Boqueria and the walk to Barceloneta are all on foot, and Sants is a direct L3 ride for the Sep 4 train. ⚠️ The trade is the morning — Park Güell and Sagrada Família are both 25–35 min away, so Sep 3 starts with a commute.", cost: "✅ $136/night, paid" },
    { city: "Madrid (start)", nights: 1, firstNight: 4, recommendation: "✅ BOOKED — $150, Estrecho (Line 1), by the Bernabéu", reason: "✅ THE OPEN QUESTION ON THIS HOTEL IS ANSWERED: the event is ONE BLOCK from Estrecho station, so stay right there and do not chase a cheaper outer barrio. It is not one commute, it is four — the event runs Sep 4 AND Sep 5 — and on Sep 4 you arrive from Barcelona with the two trolleys and two backpacks and go straight to it. A cheaper barrio saves maybe $20–40 and costs ~1h20 plus the only real risk of being late. ~$150/night is at the top of budget and worth it here. ✅ They hold luggage all day after checkout, which is what Sep 5 depends on. ⚠️ Ask whether the room faces the street or an interior patio — Madrid interiors are dark and airless.", cost: "✅ $150, paid" },
    { city: "Craiova", nights: 3, firstNight: 5, recommendation: "Hotel near the venue", reason: "Wedding logistics beat everything. Cheapest stop of the trip.", cost: "$60–80/night" },
    { city: "Istanbul", nights: 2, firstNight: 8, recommendation: "Hotel — Sultanahmet", reason: "🆕 Down from 4 nights. With only one core day, staying inside Sultanahmet (walk to Hagia Sophia, Blue Mosque, Topkapi, the cistern) stops being a preference and becomes the plan.", cost: "$90–130/night" },
    { city: "Cappadocia", nights: 2, firstNight: 10, recommendation: "🆕 Cave hotel — Göreme or Uçhisar", reason: "🆕 The two nights Istanbul gave up. Pay for a cave room with an east-facing terrace — you watch Saturday's balloons rise over breakfast. Two nights also buys a second balloon morning if Friday is cancelled for wind.", cost: "$130–200/night" },
    { city: "Athens", nights: 2, firstNight: 12, recommendation: "Hotel — Plaka/Monastiraki", reason: "Rooftop with an Acropolis view is worth the small premium.", cost: "$110–150/night" },
    { city: "Santorini", nights: 2, firstNight: 14, recommendation: "🆕 Caldera-view hotel — Oia or Imerovigli", reason: "🆕 UP FROM 1 NIGHT. Pay for the view — it's the entire point of going, and now you get two sunsets from it. Book both nights in the same room so Sep 15 is a fully bag-free island day.", cost: "$220–300/night" },
    { city: "Rome", nights: 2, firstNight: 16, recommendation: "✅ BOOKED — $308, ~10 min walk from the Vatican", reason: "✅ PAID: $308 for both nights, $154/night against a $140–190 estimate — the first booking in a while to land inside plan, and near the bottom of it. 🔄 NOT the Trastevere this plan suggested, and the swap is fine — but it changes Sep 17, so read this. ⛪ WHAT IT BUYS: THE VATICAN IS 10 MINUTES ON FOOT, and he wants it from the OUTSIDE only — square, facade, colonnade, photographs — with no interior, no dome climb and no Sistine Chapel. 🔑 That makes the location pay in the simplest possible way: everything he wants there is free, unticketed, queue-free and open around the clock, so it fits into the Sep 16 arrival evening and optionally the Sep 18 dawn WITHOUT taking a slot on the one big sightseeing day. ✅ Sep 17 keeps its earliest Colosseum slot and gains back the ~2h a dome climb would have cost. ⚠️ WHAT IT COSTS: Trastevere is now a ~25 min walk or a bus rather than downstairs, so the evening you eat there is a deliberate trip, not a stroll. And the Colosseum, Forum and Pantheon are all 25–40 min away rather than close. ✈️ SEP 18 AIRPORT: the plan's 'Leonardo Express from Termini' assumed a central hotel — from the Vatican that is a backtrack. Check whether Rome's €50 fixed taxi fare to FCO covers your exact address (it is defined as inside the Aurelian Walls, and Prati/Vatican sits outside, so confirm rather than assume) and if not, agree the fare before getting in or allow the extra time to reach Termini.", cost: "✅ $308 for both nights ($154/night), paid" },
    { city: "🔴 Grindelwald — night 1 (Sep 18→19) — THE LAST UNBOOKED SWISS BED", nights: 1, firstNight: 18, recommendation: "🔴 REPRICED: Grindelwald starts at ~$350 and most is $500+ — decide between paying it and sleeping down the line", reason: "🔴 THE ESTIMATE HERE WAS $150–240 AND THE MARKET SAYS $350–500+. That is the second time Grindelwald has broken a guess in this plan. Fri Sep 18 is a weekend night and Sat Sep 19 is the Alpkäsefest at Grosse Scheidegg, so local demand is plausibly part of it, but the cause is unconfirmed. 🔑 WHAT THE NIGHT ACTUALLY BUYS: the Pfingstegg toboggan that afternoon (~CHF 10), the Eiger north face over dinner, and — this is 90% of the value — a Sep 19 morning with NO commute, when you must get the bags to the Spinne in Grindelwald and be up First early. ✅ THE 08:00 GONDOLA IS A PREFERENCE, NOT A CONSTRAINT: it exists to beat the mountain-cart queue, which only reaches 110 min around midday. From Interlaken the Sep 19 morning runs 07:35 train · Grindelwald 08:10 · bags to the Spinne 08:25 · gondola 08:40 · at First ~09:05, against ~08:20 from the village. 45 minutes later, still well ahead of the queue. 🗺️ AND NOTE THE GEOGRAPHY, because it is the whole reason this works: Interlaken is not a detour, it is the second-to-last stop — Grindelwald sits 34 min BEYOND it on the same journey from Geneva. Stopping there means getting off one stage early, not going somewhere else. 🔄 THE CALL CHANGED, AND HERE IS THE ERROR THAT CAUSED IT. An earlier version said pay the $350, counting 'the Eiger evening' among the things you would lose by sleeping down the valley. That was wrong: SEP 19 IS THE SPINNE, with a heated outdoor infinity pool facing the Eiger north face, already paid. The Eiger evening is not lost by skipping Sep 18 in the village — it is the following night, and better. ✅ SO WHAT IS GENUINELY UNIQUE TO SLEEPING IN GRINDELWALD ON SEP 18 IS ONLY: the Pfingstegg toboggan (CHF 10, ~1h), ~45 min of the Sep 19 morning, and not carrying bags on a 34-min train. That is not $150 of value. 🚡 AND INTERLAKEN GIVES SOMETHING BACK: arriving ~14:40 leaves the whole evening for HARDER KULM — 10-min funicular, two-lake panorama, sunset ~19:30 — which decongests Sep 20, where it never fitted between a 10:30 paraglide, the chocolate workshop and a 16:30 arrival in Lauterbrunnen. 🥇 BEST OF ALL IS BURGLAUENEN OR WILDERSWIL near $200: same line, and Burglauenen is only ~12 min from Grindelwald, so the Sep 19 morning barely changes — but there is nothing to DO in either village that evening, and Burglauenen may simply have no rooms. 🔴 THE ARGUMENT THAT SETTLES IT, AND IT IS ABOUT RISK, NOT MONEY: the only thing Grindelwald uniquely buys on Sep 18 is the Pfingstegg toboggan, which closes ~17:00 against a ~15:15 arrival — about 20 minutes of slack after check-in. Sep 18 is a flight plus three trains, the most linked day of the trip, and a 45-minute delay anywhere in it erases the toboggan entirely. So the $150 premium is contingent on everything running on time. ✅ Interlaken's Harder Kulm is not: the funicular runs into the evening, sunset is ~19:30, and arriving at 14:40 leaves hours of slack. It also LIFTS Harder Kulm off Sep 20, which never had room for it between a 10:30 paraglide, the chocolate workshop and a 16:30 arrival in Lauterbrunnen — so it is a gain, not just a saving. 📷 And for a photographer the two-lake panorama at sunset beats a toboggan run. ⚠️ WHAT INTERLAKEN COSTS IN RISK, stated plainly: Sep 19 then depends on the 07:35 train (miss it and you reach First ~10:00, into the rising mountain-cart queue), and on the Spinne accepting luggage at ~08:25 — ask them. ☁️ And if Sep 19 turns into the Alpkäsefest Plan B, that bus leaves from Grindelwald, adding ~35 min. ❌ NOT the Schützen in Lauterbrunnen for this night either: Sep 19 would be 40 min with a change at Zweilütschinen, worse than Interlaken's 34 direct, and Lauterbrunnen's sights are already your Sep 21. 🔍 BUT RUN THREE CHECKS FIRST — (1) price Sep 17 and Sep 20 in Grindelwald; if they are normal this is event pricing, if the whole week is $350 it is just season; (2) try the small halts on the same line — BURGLAUENEN, SCHWENDI, GRUND (lower Grindelwald) and WILDERSWIL at the junction, all 5–25 min out and usually much cheaper; (3) ask the SPINNE for Sep 18 as well — probably dearer than $350, but it would delete the Sep 19 bag-walk entirely and give you the spa on both evenings. ✅ IF WILDERSWIL OR BURGLAUENEN COMES IN NEAR $200, TAKE IT — on the line, and you give up almost nothing. ❌ AND NOT AN EXTRA ROME NIGHT: arriving Sep 19 at ~15:15 deletes First, the Cliff Walk, the Flieger and BACHALPSEE, the best photograph on the trip, and means rebooking the Rome→Geneva flight. Saving ~$185 that way costs the best alpine day you have.", cost: "🔴 $350–500 real market (was estimated $150–240)" },
    { city: "Grindelwald — Hotel Spinne (Sep 19→20)", nights: 1, firstNight: 19, recommendation: "✅ BOOKED — $544", reason: "✅ PAID, and the deliberate splurge of the trip. Bought for one thing: the heated OUTDOOR INFINITY POOL with an unobstructed Eiger panorama and a balcony view, which no guesthouse in the village offers. Also whirlpool, Finnish and alpine-herb saunas, steam room, ice Kneipp room. 🔴 Spa 12:00–21:00, check-in 15:00 — which is exactly why it lands on Sep 19: you come down from First and the Bachalpsee around 16:00 and walk straight in. ⚠️ 2.3–3× the $180–240 nightly budget, spent knowingly on one night rather than spread thin over four.", cost: "✅ $544, paid" },
    { city: "🆕 Lauterbrunnen — nights 3–4 (Sep 20→22)", nights: 2, firstNight: 20, recommendation: "✅ BOOKED — HOTEL SCHÜTZEN LAUTERBRUNNEN, $568 for the two nights", reason: "🆕 THE THIRD ANSWER TO THIS SLOT, and the right one. It went Grindelwald → Interlaken → here. Grindelwald quoted ~$800 for these two nights (the sub-$400 listings there were hostels and shared rooms). Interlaken came in at ~$400, so the plan moved there — but Interlaken is a resort TOWN on a flat plain between two lakes, and what he actually wants is the postcard: a small village under a huge wall. Interlaken is not that. 🏔️ LAUTERBRUNNEN IS: a tiny village on the floor of a U-shaped valley with 500m vertical walls on both sides and the STAUBBACH falling 300m directly behind the houses. 72 waterfalls in the valley. It is the landscape that gave Tolkien Rivendell. 💰 ✅ PAID AT $568 — against ~$400 in Interlaken and ~$800 in Grindelwald, so $168 for the view and $232 saved against the village that was originally planned. ✅ AND SEP 21 IS THE LAUTERBRUNNEN DAY, so he wakes up inside it: zero commute on the day that was going to cost ~80 min of train from Grindelwald. Sep 22 is 20 min to Interlaken Ost for the 11:07 GoldenPass. ☁️ THE ONE HONEST DRAWBACK, and it matters with a real camera: the valley is deep and narrow, so the sun drops behind the west wall early and late-September afternoon light is short. The open-bowl alpenglow on the Eiger is a Grindelwald thing, and he still has it on Sep 18 and from the Spinne on Sep 19 — the two nights that were always the view nights. 🔴 ASK AT BOOKING: which way the room faces (Staubbach side is the one you want), and whether they hold luggage before check-in.", cost: "✅ $568 for both nights ($284/night), paid" },
    { city: "Paris", nights: 4, firstNight: 22, recommendation: "Airbnb — Le Marais / 11th", reason: "🆕 Now Sep 22–26. Kitchen breakfasts across 4 nights, and easy RER A access for both Disney days.", cost: "$170–210/night" },
    { city: "Madrid (end)", nights: 3, firstNight: 26, recommendation: "🆕 Hotel near Atocha — NOT the airport", reason: "🆕 UP FROM 2 NIGHTS (London's). Atocha is now the right call rather than an airport hotel, because the Toledo AVE leaves from there and you arrive at a civilised hour from Orly instead of late at night. ⚠️ If you decide to do Segovia instead of Toledo, that one leaves from Chamartín — check before booking.", cost: "$110–150/night" }
  ]
};
...
const BOOKINGS = [
  ...
  { priority: 10, what: "🍫 Funky Chocolate Club workshop, Interlaken — 🆕 SUN SEP 20, ~14:00", when: "2–3 weeks ahead", urgency: "medium", note: "🆕 MOVED AGAIN, and this is its final slot: Sun Sep 20 at ~14:00, straight after the paraglide comes down around 13:00. Make-your-own-bar class, ~1h30, 20 min walk from Interlaken Ost with the bags already in a locker. 🔴 IT IS THE DESIGNATED DROP. Sep 20 fits the flight plus ONE more thing, and if the operator cannot fly you before ~11:30 this is what goes — you are not trading daylight in the Lauterbrunnen valley for chocolate. ⛵ Swap-ins if you would rather: the boat one way to Iseltwald plus the train back, or Harder Kulm. funkychocolateclub.com", estimatedCost: "~CHF 65/person" },
  ...
  { priority: 12, what: "✅ DONE — Disney Adventure World, FRI SEP 25 (2 pax)", when: "✅ BOOKED — $164", urgency: "low", note: "✅ BOUGHT AND PRICED, $82/person. ✅ Confirmed as ADVENTURE WORLD, not a second Disneyland Park day — which is the answer the plan needed: the two nighttime shows run SIMULTANEOUSLY, so only a second park buys you the second show, and Sep 23 already holds the reserved castle-show viewing. Frozen Ever After, Ratatouille, Avengers Campus and Cascade of Lights are all on this day. ⏰ Rope drop 09:30 — Frozen Ever After first, Crush's Coaster second. ❌ No hopper, no Premier Access Ultimate (€110–230/person); a single-ride Premier Access for Frozen is the only one worth considering, decided that morning in the app.", estimatedCost: "✅ $164 paid for two" },
  ...
  { priority: 20, what: "✅ DONE — Swiss Half Fare Cards + GoldenPass ticket and seat reservation", when: "✅ Both paid", urgency: "low", note: "✅ NOTHING IN SWITZERLAND CAN SELL OUT ON YOU ANY MORE. The two Half Fare Cards are paid ($380, valid Sep 18 → Oct 18) and the GoldenPass is paid: CHF 20 reservation + CHF 28 half-fare ticket per person, CHF 96 for the two, $120. 11:07 from Interlaken Ost on Tue Sep 22, 2nd class. 🔴 THE PASS QUESTION IS CLOSED — an earlier version of this entry told you to buy the 4-day Swiss Travel Pass. It was wrong for this itinerary: removing Zermatt deleted the two long expensive rail legs, and what is left is mountain LIFTS, which the pass discounts 50% — exactly what the card gives at half the price. Half Fare Card CHF 382/person all-in against ~483 for the 4-day pass. ⚪ WHAT REMAINS IS ALL UNRESERVABLE BY NATURE, so buy it from a machine as you go: Sep 18 Geneva→Grindelwald (~CHF 39/person flexible with the card), the Sep 20 hops, and on Sep 22 Lauterbrunnen→Interlaken Ost (~4) and Montreux→Geneva (~16.50). None of it has a quota.", estimatedCost: "✅ $500 paid — $380 cards + $120 GoldenPass" },
  ...
  { priority: 22, what: "✅ DONE — Hotel Spinne Grindelwald, SAT SEP 19 (1 night)", when: "✅ Paid", urgency: "medium", note: "✅ BOOKED — $544. The heated OUTDOOR INFINITY POOL with an unobstructed Eiger panorama, which is the one thing four guesthouse nights could not buy. 🔴 SPA AND POOL OPEN 12:00–21:00 ONLY, check-in 15:00 — so it works precisely because you come down from First and the Bachalpsee around 16:00. 🧳 Bags go to the Spinne reception on the morning of Sep 19 — a ~10-minute walk inside the village. 🆕 On the morning of Sep 20 they leave Grindelwald altogether, down to the Interlaken hotel on the train you were taking for the paraglide anyway.", estimatedCost: "✅ $544 paid" },
  { priority: 23, what: "🔴 Grindelwald, SEP 18→19 — the last Swiss bed, and it is expensive", when: "🔴 NOW", urgency: "high", note: "🔴 THE WARNING ON THIS ENTRY CAME TRUE: the $150–240 estimate is dead, Grindelwald starts at ~$350 and most listings are $500+. Fri Sep 18 is a weekend night before the Sat Sep 19 Alpkäsefest, which may be part of it. 🔄 RECOMMENDATION REVERSED — SLEEP DOWN THE LINE IF ANYTHING DECENT IS NEAR $200. The earlier advice to pay the $350 counted 'the Eiger evening' as a loss, which was an error: Sep 19 is the Spinne, infinity pool facing the Eiger, already paid. What Sep 18 in the village uniquely buys is the Pfingstegg toboggan, ~45 min of the next morning, and not carrying bags on a 34-min train — not $150 of value. 🚡 Interlaken also hands back HARDER KULM on the Sep 18 evening (arrive ~14:40, sunset ~19:30), which never fitted into Sep 20. 🥇 BURGLAUENEN or WILDERSWIL are better still: same line, and Burglauenen is ~12 min from Grindelwald. 🔍 THREE CHECKS, ten minutes: (1) price Sep 17 and Sep 20 in Grindelwald to tell event pricing from plain season; (2) try BURGLAUENEN, SCHWENDI, GRUND and WILDERSWIL — small halts on the same line, 5–25 min out, usually far cheaper; (3) ask the SPINNE for Sep 18 too, which would delete the Sep 19 bag-walk and add a spa evening. ✅ THE SEP 19 MORNING FROM DOWN THE LINE: 07:35 train · Grindelwald 08:10 · bags to the Spinne 08:25 · gondola 08:40 · First ~09:05, against 08:20 from the village. The 08:00 gondola only exists to beat the midday mountain-cart queue, and 09:05 is still well clear of it. 🔴 CONFIRM the Spinne takes luggage from ~08:20; reception is staffed, but the morning rests on it. ❌ DO NOT solve this with an extra Rome night: arriving Sep 19 at 15:15 costs you First and Bachalpsee and a flight change, to save ~$185.", estimatedCost: "🔴 $350–500 — repriced from the real market" },
  { priority: 24, what: "✅ DONE — Madrid hotel, Estrecho (Fri Sep 4 → Sat Sep 5)", when: "✅ Paid", urgency: "medium", note: "✅ BOOKED — $150, room only. Double, 16 m², A/C, ONE BLOCK from Estrecho station and from the Sep 5 event venue. ✅ Confirmed they hold luggage all day after checkout — the whole of Sep 5 rests on that. Breakfast was deliberately skipped (+$14): Estrecho is a residential barrio and a bar tostada con tomate with coffee is €3–4.50pp and better. 🚕 On Sep 5 take the €33 flat-rate taxi to Barajas rather than L1→L8 — 17:00 is rush hour and the day ends in an international flight.", estimatedCost: "✅ $150 paid" },
  { priority: 25, what: "🏫 Early-years school visits, Madrid — MON SEP 28 (not Sep 4)", when: "🔴 START NOW — needs weeks of lead time", urgency: "high", note: "🔴 THE DATE MOVED FOR A HARD REASON: the Madrid 2026/27 school year starts MONDAY SEP 7 for Infantil and Primaria. On Sep 4 the centres have no children in them, so there is nothing to observe. Sep 28 is a Monday three weeks into term — centres running normally. ⚠️ YOU CANNOT WALK IN: child-safeguarding rules mean every visit needs prior arrangement, so email now. 💡 International and private schools accept foreign visitors far more readily than public ones — public centres need Consejería authorisation and rarely grant it to individuals — and they tend to have more of the classroom technology you want to see. Aim for ~09:30–12:30; mornings are the working part of the day. ⚠️ If the visits come through, Segovia comes out of Sep 28.", estimatedCost: "Free, but needs lead time" },
  { priority: 26, what: "🆕 Madrid hotel near ATOCHA — 3 nights (Sep 26, 27, 28)", when: "1 month ahead", urgency: "medium", note: "🆕 UP FROM 2 NIGHTS, and the neighbourhood changed: Atocha, not the airport. You now land from Orly at a civilised hour instead of late at night, and Atocha is where the Toledo AVE leaves from. ⚠️ Segovia leaves from Chamartín instead — decide which day trip you want before booking.", estimatedCost: "$110–150/night" },
  { priority: 27, what: "Reconfirm Le Jules Verne (Sep 24, 8pm)", when: "Sep 22", urgency: "medium", note: "✅ Already booked, and it is the fixed point the entire itinerary was rebuilt around. Reconfirm 48h ahead and check the dress code — jacket required for men.", estimatedCost: "Already committed" },
  { priority: 28, what: "✅ DONE — Lima↔Madrid round-trip, Plus Ultra PNR XYJSDU", when: "✅ Paid", urgency: "medium", note: "✅ $1,968 for two both ways + ~€50 seat selection. Well bought — comparable options were ~$1,700/person. Lima Sep 1 18:10 → Madrid Sep 2 12:45 (PU0302) · Madrid Sep 29 11:00 → Lima 16:10 (PU0301). Seats are already chosen, so all that's left is online check-in 24h before each leg.", estimatedCost: "✅ $2,022 paid" }
];
