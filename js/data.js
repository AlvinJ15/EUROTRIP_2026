...
const ITINERARY = [
  ...
  },
  {
    ...
    dayByDay: [
      ...
      { day: "Sep 20 (Sun)", plan: "🪂 INTERLAKEN DAY. 🧳 🆕 THE BAGS LEAVE GRINDELWALD FOR GOOD TODAY, AND THEY GO VIA A LOCKER — this is the one bit of the Lauterbrunnen move that needs thinking about. Check out of the Spinne ~10:00 and take the trolleys straight down to INTERLAKEN OST (35 min direct), then into a station locker (~CHF 9). ❌ DO NOT detour through Lauterbrunnen to drop them first: that is 40 min with a change at Zweilütschinen and then 20 min back out, ~60 min of travel before the flight instead of 35. ✅ Collect them ~18:00 and ride 20 min up to Lauterbrunnen, checking in around 18:45. Daypack all day. 🕑 The Schützen's 14:00 check-in never binds — you are flying at 14:00 and arrive nearly five hours after it. 🔴 And the locker is compulsory, not a convenience: you BOTH fly, so nobody is left on the ground with the bags. Budget for two lockers and put the camera in as well — tandem pilots shoot with their own. ⏰ Book the paraglide for ~13:00, which leaves the Spinne checkout completely unhurried. TANDEM PARAGLIDE FROM BEATENBERG: 20–30 min over Lake Thun and Lake Brienz with the Eiger–Mönch–Jungfrau wall behind you. ⚠️ Allow 2h–2h30 door to door: check-in 15 min · minibus up 25–30 min · briefing and wait 15–30 min · flight · landing and photos 15 min. Then choose: ⛵ LAKE BRIENZ CRUISE (turquoise glacial water, covered by the pass) or 🚡 HARDER KULM (10-min funicular to the two-lake panorama). 🍫 FUNKY CHOCOLATE CLUB in the late afternoon — make and take home your own bars. 🔴 ONLY TWO OF THOSE THREE FIT after a ~13:00 flight, and the full Lake Brienz round trip (~2h40) is not one of them — take the boat ONE WAY to Iseltwald and the train back (~1h30) if you want the water. 🆕 Then bags out of the locker and 20 min up to LAUTERBRUNNEN, arriving to the Staubbach falls lit up behind the village. Dinner there." },
...
const BUDGET = {
  ...
  total: { min: 14859, max: 18633, target: 15000 },
  savingTips: [
...
const BOOKINGS = [
  ...
  { priority: 23, what: "🏨 Grindelwald guesthouse (Sep 18→19) + 🆕 HOTEL SCHÜTZEN, LAUTERBRUNNEN (Sep 20→22)", when: "🔴 NOW", urgency: "high", note: "🆕 TWO BOOKINGS, AND THE SECOND ONE IS FOUND AND PRICED: Hotel Schützen Lauterbrunnen, $555 for both nights. Against ~$800 in Grindelwald and ~$400 in Interlaken — the $155 premium over Interlaken buys a village on a valley floor under 500m walls instead of a resort town on a plain, which is the Switzerland he actually came for. ✅ SEP 18 STAYS IN GRINDELWALD: a ~15:15 arrival and an 08:00 Firstbahn next morning both need the village, and one night's premium is small. Stay near the station. 🔴 ASK THE SCHÜTZEN TWO THINGS BEFORE PAYING: (1) which way the room faces — you want the Staubbach side; (2) whether they hold luggage before check-in. Even a no on (2) is survivable, because the bags go into an Interlaken Ost locker on Sep 20 anyway and only come up in the evening.", estimatedCost: "$150–240 for Sep 18 + $555 for Sep 20→22" },
