...
const TICKETS = [
  ...
  },
  {
    ...
    attractions: [
      ...
      { name: "🎟️ SAVER DAY PASS for Sep 22 — check this before buying point-to-point", price: "CHF 61/person undiscounted (vs ~CHF 101 in single tickets)", note: "🔴 SURFACED BY SBB WHILE BOOKING THE GOLDENPASS AND ALMOST MISSED. Sep 22 is not one journey, it is three: Grindelwald→Interlaken Ost (~12) + Interlaken Ost→Montreux (56) + Montreux→Geneva (~33) ≈ CHF 101 in singles. A Saver Day Pass covers the whole Swiss network for the day at CHF 61 — about CHF 40/person, CHF 80 for the two of you. ⚠️ The booking engine compares it only against the middle leg, which is why it looks like the dearer option there. ✅ Confirm it carries you all the way to Geneva before buying — it should, that is GA-network territory. ⚠️ Non-refundable and date-locked, which costs nothing here since the seat reservation already pins you to the 11:07. 💡 Saver Day Passes are demand-priced and have a separate, lower price for Half Fare Card holders — price it both ways once the cards are bought. ❌ Ignore the City-Ticket at CHF 63.80: what it adds is Montreux city transport, and Montreux is a platform change." },
