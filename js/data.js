...
const ITINERARY = [
  {
    ...
    tips: [
      ...
      "🔴 THE ONE OPEN ITEM IN SPAIN: check which Sep 4 Barcelona→Madrid departure you actually hold, against when your event starts. If the event begins before midday you want the ~07:00, not the 09:00. ✅ The hotel side is settled — it is one block from the venue at Estrecho, so the train is now the only thing that can make you late. A Renfe time change is cheap while the date is far out and expensive near it.",
