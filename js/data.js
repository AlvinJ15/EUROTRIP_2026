...
const BUDGET = {
  ...
  total: { min: 14872, max: 18606, target: 15000 },
  savingTips: [
...
const BOOKINGS = [
  ...
  { priority: 23, what: "🏨 Grindelwald guesthouse, SEP 18→19 — the last Swiss bed", when: "🔴 NOW", urgency: "high", note: "✅ LAUTERBRUNNEN IS DONE (Hotel Schützen, $568 paid for Sep 20→22), so this single night is all that remains of the Swiss lodging. 🔴 IT STAYS IN GRINDELWALD AND THAT IS NOT NEGOTIABLE: you land ~15:15 and Sep 19 opens on the 08:00 First gondola, which only works from the village. One night's premium is small, and it is the night you get the Eiger north face out of the window. Stay near the station — the Firstbahn base is in the village too. ⚠️ Grindelwald priced ~$400/night for the Sep 20–21 pair, so do not assume $150–240 holds here either; check it early and book as soon as it looks reasonable.", estimatedCost: "$150–240 for one night — verify, the estimates in this village have run low" },
