...
const BUDGET = {
  categories: [
    ...
    { label: "🎫 Swiss rail — Half Fare Card + half-price tickets (×2)", min: 610, max: 850, note: "🔴 REPRICED AND THE RECOMMENDATION FLIPPED. Was a 4-day Swiss Travel Pass; the Half Fare Card wins by roughly $200 for the two of you. The pass earns its money covering long trains at 100%, but his big Swiss items are MOUNTAIN LIFTS — Schilthorn CHF 108, First CHF 43 — which the pass discounts 50%, the same as the card at half the price. The trains it would cover free are CHF 11.60 hops. Removing Zermatt deleted the two long legs that justified it. ✅ Card price confirmed at CHF 150/person on sbb.ch — CHF 300 for two. ⚠️ The range keeps the pass at the top ($850) because nothing is bought yet and the fares are estimates; the floor ($610) is the Half Fare route. 🔴 The card only pays for itself because of Schilthorn — see the tickets entry before buying. Reprice on sbb.ch — see the Switzerland tickets for the full arithmetic."},
  ...
  total: { min: 14524, max: 18608, target: 15000 },
  savingTips: [
