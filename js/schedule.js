...
const SCHEDULE = {
  ...
  20: { items: [
    ...
    { t: '09:30', dur: 25, what: '🚂 Interlaken Ost → Lauterbrunnen', kind: 'travel', note: '🔁 STRAIGHT THROUGH NOW. The old plan stopped in Interlaken all morning for a Beatenberg flight; with the paraglide moved to Mürren you just keep going to the village you sleep in.' },
    { t: '10:00', dur: 25, what: '🧳 Bags into the Hotel Schützen', kind: 'bags', note: '✅ YOUR OWN HOTEL, and this deletes the station lockers entirely — no fee, and nothing left unwatched while both of you are in the air. That was the ugliest part of the old Sep 20.' },
    { t: '10:35', dur: 20, what: '🚡 Funicular Lauterbrunnen → Grütschalp', kind: 'travel' },
    { t: '11:00', dur: 20, what: '🚂 Panorama train Grütschalp → Mürren', kind: 'travel' },
    { t: '11:30', dur: 30, what: '✍️ Operator check-in + briefing', kind: 'fixed', fixed: true, note: '🔴 BOOK THIS. Ask three things when you do: (1) if they cancel on the 20th, do they rebook you on the 21st — that is the whole insurance policy; (2) do they hold daypacks during the flight; (3) exactly where you land, so you know the walk back.' },
    { t: '12:05', dur: 75, what: '🪂 PARAGLIDE MÜRREN → the valley floor', kind: 'fixed', fixed: true, note: '⭐ Launch ~1,650m, landing ~800m. You fly INSIDE the Lauterbrunnen valley — 500m walls both sides, the waterfalls beside you, Eiger–Mönch–Jungfrau directly opposite rather than far off. 15–25 min airborne against 10–15 from Beatenberg. ~CHF 200–230/person.' },
    { t: '13:30', dur: 60, what: '🍽️ Lunch in Lauterbrunnen', kind: 'food' },
    { t: '14:40', dur: 10, what: '🚌 Bus → Trümmelbach', kind: 'travel' },
    { t: '14:55', dur: 70, what: '💧 TRÜMMELBACH FALLS — inside the mountain', kind: 'act', note: '🔁 MOVED HERE FROM SEP 21, and this is the second half of the insurance. Ten glacier waterfalls INSIDE the rock, reached by a tunnel lift — it drains the Eiger, Mönch and Jungfrau, up to 20,000 litres a second. ⚠️ CHF 14 · check last admission, it comes forward in September. ✅ Emptying Sep 21 of it is what leaves room to re-fly tomorrow if today gets blown out.' },
    { t: '16:15', dur: 20, what: '🚌 Bus back to Lauterbrunnen', kind: 'travel' },
    { t: '16:45', dur: 30, what: '🏨 Collect the room at the Schützen', kind: 'bags' },
    { t: '17:25', dur: 75, what: '📷 Staubbach falls + the village, in full light', kind: 'act', note: '✅ AND NOW WITH HOURS TO SPARE. The whole reason this day was pulled early was to see the valley lit — the walls are 500m and the sun leaves the floor early. You are now here from 09:55 instead of 16:35.' },
  ...
  21: { items: [
    ...
    { t: '14:05', dur: 60, what: '🏘️ Mürren — car-free village on the cliff', kind: 'act', note: '🪂 THIS IS THE PARAGLIDE RESERVE. If Sep 20 was blown out, the flight goes here instead: you are already in Mürren, the operator is here, and the flight REPLACES the cable-car descent below rather than adding to the day. That is why Trümmelbach was moved off this day.' },
    { t: '15:10', dur: 50, what: '🥾 Walk Mürren → Gimmelwald', kind: 'act', note: '🆕 downhill through meadows, ~45 min, and Gimmelwald is smaller and less visited than Mürren · skip it if you are flying today' },
