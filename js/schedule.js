...
const SCHEDULE = {
  ...
  21: { items: [
    { t: '07:15', dur: 30, what: 'Breakfast — early, on purpose', kind: 'food', note: '☁️ Check the Schilthorn webcam. Cloud up there does not change the morning: the cart runs under cloud, only rain closes it.' },
    ...
    { t: '08:30', dur: 10, what: '🎫 FIRST VALLEY COUNTER — buy cart + trottibike + gondola', kind: 'fixed', fixed: true, note: '🔴 THE WHOLE POINT OF THE EARLY START. Cart tickets are sold ONLY here, at the counter, never online, and the daily number is limited — Sep 19 you were counted out of the Schreckfeld queue at 15:20. Buy one-way gondola to Schreckfeld (½ with the card) + MOUNTAIN CART CHF 25 + TROTTIBIKE CHF 19 per person, hold the paper, then go up. Min height 135 cm.' },
    { t: '08:40', dur: 20, what: '🚡 Gondola → SCHRECKFELD', kind: 'travel', note: 'the middle station, not the top' },
    { t: '09:00', dur: 35, what: '🛴 MOUNTAIN CART · Schreckfeld → Bort (3 km)', kind: 'act', note: '🔁 THE ONE YOU LOST. First cart of the day, nobody in front of you. 15–20 min of natural road. Closed if the road is wet — if so, PFINGSTEGG toboggan opens 10:00, 15 min from the station.' },
    { t: '09:40', dur: 40, what: '🛴 TROTTIBIKE · Bort → Grindelwald village (4.5 km)', kind: 'act', note: 'quiet paved roads, ends 5 min from the station' },
    { t: '10:35', dur: 40, what: '🚂 Grindelwald → Lauterbrunnen', kind: 'travel', note: '~11:15' },
    { t: '11:20', dur: 15, what: '🚌 Bus → Stechelberg', kind: 'travel' },
    { t: '11:45', dur: 22, what: '🚡 Cable car Stechelberg → Gimmelwald → Mürren', kind: 'travel', note: 'the OTHER way up — today’s two ascents never repeat scenery' },
    { t: '12:10', dur: 40, what: '🚡 Cable car Mürren → Birg → Schilthorn', kind: 'travel' },
    { t: '12:50', dur: 40, what: '🏔️ SCHILTHORN 2,970m — Skyline, Bond World', kind: 'act', note: '☁️ cloud makes this CHF 108 of fog, no refund — if the webcam was grey at breakfast, stop at Mürren instead: Allmendhubel + the Mürren–Gimmelwald walk' },
    { t: '13:30', dur: 75, what: '🍽️ Piz Gloria revolving restaurant — lunch', kind: 'food', note: 'the only restaurant meal today · ~$75–105 for the two · out of the food line' },
    { t: '14:55', dur: 40, what: '🌉 Thrill Walk at Birg — glass floor', kind: 'act' },
    { t: '15:45', dur: 15, what: '🚡 Down to Mürren', kind: 'travel', note: '🪂 RESERVE SLOT: if wind cancelled yesterday’s flight, drop to Stechelberg from here for the 15:20 — leave Birg by 14:40 in that case.' },
    { t: '16:00', dur: 70, what: '🚡 ALLMENDHUBEL funicular + Flower trail', kind: 'act', note: 'every 20 min to 17:00 · 4 min up to 1,907m · Eiger, Mönch and Jungfrau straight ahead · the soft ending to a 07:15 day. ❌ Via ferrata dropped: it would end past its 18:00 close.' },
    { t: '17:15', dur: 30, what: '🚡 Mürren → Gimmelwald → Stechelberg', kind: 'travel' },
    { t: '17:50', dur: 20, what: '🚌 Bus → Lauterbrunnen', kind: 'travel' },
