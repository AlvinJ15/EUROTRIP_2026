...
const SCHEDULE = {
  ...
  20: { items: [
    ...
    { t: '09:30', dur: 25, what: '🚂 Interlaken Ost → Lauterbrunnen', kind: 'travel' },
    { t: '10:00', dur: 25, what: '🧳 Bags into the Hotel Schützen', kind: 'bags', note: '✅ Your own hotel that night, so the station lockers are gone entirely — no fee, and nothing left unwatched while both of you are in the air.' },
    { t: '10:40', dur: 15, what: '🚌 Bus Lauterbrunnen → STECHELBERG', kind: 'travel', note: '🔁 CORRECTED ROUTING. The operator meets at the Stechelberg cable-car station at the head of the valley — NOT in Mürren, and not via Grütschalp. PostBus down the valley floor, ~15 min.' },
    { t: '11:00', dur: 20, what: '✍️ Check-in at the Schilthornbahn valley station', kind: 'buffer' },
    { t: '11:20', dur: 120, what: '🪂 PARAGLIDE — Birg 2,600m → Stechelberg', kind: 'fixed', fixed: true, note: '⭐ THE 11:20 SLOT. Cable car up to BIRG, a 10-minute walk to launch, 5 min to kit up, then 20–25 MINUTES AIRBORNE — a 1,730m descent between the two walls, over Gimmelwald, Mürren and the Trümmelbach falls, with Eiger–Mönch–Jungfrau in front of you. Lands back at Stechelberg. ⏱️ Two hours door to door. 💰 $234/person, $468 for the two. 🧥 DRESS FOR 2,600m IN LATE SEPTEMBER — it will be near freezing at launch and you are standing around for 15 min before you fly. Gloves and a hat, not just a jacket. ⚠️ CONFIRM THEY ARE STILL ON THE SUMMER PROGRAMME on Sep 20: summer launches from Birg at 2,600m, winter from Schilgrat at 2,100m. Sep 20 should be summer, but it is worth one question — it is 500m of your flight.' },
    { t: '13:30', dur: 60, what: '🍽️ Lunch at Stechelberg', kind: 'food' },
    { t: '14:40', dur: 10, what: '🚌 Bus Stechelberg → Trümmelbach', kind: 'travel', note: '✅ Same road, one stop back down the valley — it is on the way home, not a detour.' },
    { t: '14:55', dur: 70, what: '💧 TRÜMMELBACH FALLS — inside the mountain', kind: 'act', note: '🔁 MOVED HERE FROM SEP 21 to keep tomorrow free as the weather reserve. ⭐ And the order is now perfect by accident: you fly OVER these falls at midday and walk INSIDE them two hours later. Ten glacier cascades within the rock, reached by a tunnel lift, draining the Eiger, Mönch and Jungfrau at up to 20,000 litres a second. ⚠️ CHF 14 · check last admission, it comes forward in September.' },
    { t: '16:15', dur: 15, what: '🚌 Bus → Lauterbrunnen', kind: 'travel' },
    { t: '16:45', dur: 30, what: '🏨 Collect the room at the Schützen', kind: 'bags' },
    { t: '17:25', dur: 75, what: '📷 Staubbach falls + the village, in full light', kind: 'act', note: '✅ With hours to spare. The valley floor loses the sun early behind 500m walls — this whole day was pulled forward to be here in daylight, and you now arrive at 09:55 instead of 16:35.' },
  ...
  21: { items: [
    ...
    { t: '14:05', dur: 60, what: '🏘️ Mürren — car-free village on the cliff', kind: 'act', note: '🪂 THE PARAGLIDE RESERVE STILL WORKS — and better than expected, now that the operator is known to start and finish at STECHELBERG. Your descent today already ends there. If wind cancels Sep 20, take their 15:20 slot: leave Mürren after this, be at Stechelberg by ~15:00, fly 15:20–17:20, and you lose only the Gimmelwald walk below. Schilthorn, Piz Gloria and the Thrill Walk all survive untouched. ✅ That is why Trümmelbach was moved off this day.' },
    { t: '15:10', dur: 50, what: '🥾 Walk Mürren → Gimmelwald', kind: 'act', note: '🆕 ~45 min downhill through meadows, and Gimmelwald is smaller, quieter and far less visited than Mürren. 🪂 THIS IS THE ONE THING THE PARAGLIDE RESERVE COSTS — if you are re-flying today, skip this walk, drop straight to Stechelberg and take the 15:20 slot.' },
    { t: '16:10', dur: 30, what: '🏘️ Gimmelwald', kind: 'act' },
    { t: '16:45', dur: 15, what: '🚡 Cable car Gimmelwald → Stechelberg', kind: 'travel' },
    { t: '17:10', dur: 25, what: '🚌 Bus → Lauterbrunnen', kind: 'travel' },
