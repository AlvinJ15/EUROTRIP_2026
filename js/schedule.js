...
const SCHEDULE = {
  ...
  20: { items: [
    ...
    { t: '11:30', dur: 30, what: '📷 First look at the village', kind: 'act', note: 'Staubbach gets its proper session tomorrow at 08:40, when it is front-lit.' },
    ...
    { t: '12:40', dur: 40, what: '✍️ Walk to the meeting point, check in', kind: 'buffer', note: '40 min in hand, on foot, bags dropped, having eaten lightly. Nothing about this arrival is a scramble.' },
    { t: '13:20', dur: 110, what: '🪂 PARAGLIDE — ✅ BOOKED, meets in MÜRREN', kind: 'fixed', fixed: true, note: '⭐ THE 13:20 SLOT IS THE BEST LIGHT OF THE DAY: solar noon ~13:25, the valley floor fully lit AND the Eiger–Mönch–Jungfrau wall front-lit instead of backlit. 20–25 min airborne over Gimmelwald and the Trümmelbach falls. 💰 $234/person, $468 for the two — paid from the Switzerland activities line, NOT from today’s $170 food + pocket. 🧥 Near-freezing at launch, ~15 min standing around first: gloves and a hat. 🛬 The rest of the day assumes you LAND AT STECHELBERG — confirm when you meet. If they return you to Mürren, ride the cable car down to Stechelberg and pick the plan up there.' },
    { t: '15:10', dur: 35, what: '🍽️ Late lunch at Stechelberg', kind: 'food', note: 'you will have earned it — and this one comes out of the $170' },
    { t: '15:45', dur: 10, what: '🚌 Bus → Trümmelbach', kind: 'travel', note: 'two stops down the valley floor' },
    { t: '15:55', dur: 65, what: '💧 TRÜMMELBACH FALLS — inside the mountain', kind: 'act', note: '🔁 BACK ON SEP 20. Open to ~17:00 in September — ask the Schützen for the exact last admission when you drop the bags. Ten glacier cascades inside the rock, tunnel lift, CHF 14. Moving it here frees tomorrow afternoon for the via ferrata.' },
  ...
  21: { items: [
    { t: '07:45', dur: 45, what: 'Breakfast — no train today, you wake up in the valley', kind: 'food', note: '☁️ Check the Schilthorn webcam AND the afternoon forecast: the via ferrata is good-weather only.' },
    { t: '08:40', dur: 50, what: '📷 STAUBBACH + valley walk — front-lit', kind: 'act', note: '⭐ THIS IS STAUBBACH AT ITS BEST HOUR. It faces east off the west wall; morning light hits it square.' },
    { t: '09:40', dur: 20, what: '🚡 Funicular → Grütschalp', kind: 'travel' },
    { t: '10:05', dur: 20, what: '🚂 Panorama train → Mürren', kind: 'travel' },
    { t: '10:25', dur: 20, what: '🧗 Rent via ferrata gear — Intersport Mürren', kind: 'act', note: 'harness, via ferrata set, helmet, gloves · ~CHF 30–40/person — the mountain-cart money. 🔴 ASK how and where to return it: the route ends in Gimmelwald, one 5-min cable-car stop below.' },
    { t: '10:50', dur: 40, what: '🚡 Cable car Mürren → Birg → Schilthorn', kind: 'travel' },
    { t: '11:30', dur: 60, what: '🏔️ SCHILTHORN 2,970m — Skyline, Bond World', kind: 'act', note: '☁️ cloud makes this CHF 108 of fog, no refund' },
    { t: '12:30', dur: 75, what: '🍽️ Piz Gloria revolving restaurant — lunch', kind: 'food', note: 'the only restaurant meal today · ~$75–105 for the two · out of the food line' },
    { t: '13:50', dur: 45, what: '🌉 Thrill Walk at Birg — glass floor', kind: 'act' },
    { t: '14:40', dur: 20, what: '🚡 Down to Mürren · walk to the Sportchalet', kind: 'travel', note: 'the via ferrata starts at the Sportchalet, ~10 min from the cable car. 🪂 RESERVE SLOT: if wind cancelled yesterday’s flight, drop to Stechelberg from here for the 15:20 and skip the via ferrata.' },
    { t: '15:00', dur: 165, what: '🧗 VIA FERRATA Mürren → Gimmelwald', kind: 'act', note: '🆕 THE MOUNTAIN-CART REPLACEMENT. 2.2 km, 300m down, ~2.5–3h, K3: ladders, iron rungs, cabled traverses 400m above the valley floor and a wire suspension bridge. Self-belayed the whole way — clip, move, clip. Open 09:00–18:00 to Oct 31; 15:00 is the latest sensible start. 🟠 If either of you hesitated on the Cliff Walk, take the ALLMENDHUBEL funicular + Mountain View trail instead (soft option, same peaks).' },
    { t: '17:45', dur: 40, what: '🚡 Gimmelwald → Stechelberg', kind: 'travel', note: 'return the gear in Mürren first if the shop asks — Gimmelwald → Mürren is a 5-min cable car' },
    { t: '18:25', dur: 20, what: '🚌 Bus → Lauterbrunnen', kind: 'travel' },
    { t: '19:15', dur: 90, what: 'Dinner', kind: 'food', note: '✅ Trümmelbach already done yesterday — nothing raced a closing time today' }
  ]},
  22: { items: [
