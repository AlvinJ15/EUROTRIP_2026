...
const SCHEDULE = {
  ...
  20: { items: [
    ...
    { t: '11:05', dur: 25, what: '🧳 Bags into the Hotel Schützen', kind: 'bags', note: '✅ Your own hotel tonight. Room at 14:00 — this is a drop, and it is all you need.' },
    { t: '11:30', dur: 30, what: '📷 First look at the village', kind: 'act', note: 'Staubbach gets its proper session tomorrow at 08:15, when it is front-lit.' },
    ...
    { t: '14:40', dur: 10, what: '🔴 THE GATE — on the 14:50 bus, or not?', kind: 'buffer', note: 'Landed and packed up by 14:45 with dry weather → the cart afternoon below. Flight delayed, or wet ground (cart closes when wet) → DROP IT: bus 15:45 to TRÜMMELBACH instead (inside the rock until ~17:00), and tomorrow keeps its original Staubbach morning. No cart is worth a second chase.' },
    { t: '14:50', dur: 20, what: '🚌 Bus Stechelberg → Lauterbrunnen', kind: 'travel', note: 'PostBus, every 30 min' },
    { t: '15:12', dur: 43, what: '🚂 Lauterbrunnen → Zweilütschinen → Grindelwald', kind: 'travel', note: 'every 30 min, one change on the same platform · ~15:55 in Grindelwald · station → First gondola is 5 min on foot' },
    { t: '16:05', dur: 20, what: '🚡 First gondola → SCHRECKFELD', kind: 'travel', note: 'ONE-WAY UP to the middle station, not to the top — ~CHF 20, half with the card. You ride the chain down from here.' },
    { t: '16:30', dur: 35, what: '🛴 MOUNTAIN CART · Schreckfeld → Bort (3 km)', kind: 'act', note: '🔁 THE ONE YOU LOST ON SEP 19. Open to 17:30; a Sunday at 16:30 in late September has no queue to speak of. CHF 19. Min height 125 cm, closed when the road is wet. ❌ There is NO cart or toboggan anywhere in the Lauterbrunnen valley — this is the nearest, ~55 min from the landing field, and the numbers work.' },
    { t: '17:10', dur: 40, what: '🛴 TROTTIBIKE · Bort → Grindelwald village (4.5 km)', kind: 'act', note: 'open to 18:00 · drops you in the village, 5 min from the station · CHF 19. 🛷 If the First gondola is closed, the PFINGSTEGG toboggan is a 15-min walk from the station — but it shuts at 17:00, so only if you are there by 16:15.' },
    { t: '18:10', dur: 40, what: '🚂 Grindelwald → Lauterbrunnen', kind: 'travel', note: '~18:50 · collect the room on the way in' },
    { t: '18:50', dur: 25, what: '🏨 Collect the room at the Schützen', kind: 'bags' },
    { t: '19:30', dur: 90, what: 'Dinner in Lauterbrunnen', kind: 'food', note: 'this one IS in the $170' }
  ]},
  21: { items: [
    { t: '07:30', dur: 40, what: 'Breakfast — no train today, you wake up in the valley', kind: 'food', note: '☁️ Check the Schilthorn webcam AND the afternoon forecast: the via ferrata is good-weather only.' },
    { t: '08:15', dur: 40, what: '📷 STAUBBACH — front-lit', kind: 'act', note: '⭐ ITS BEST HOUR. It faces east off the west wall; morning light hits it square. Free, behind the village.' },
    { t: '09:00', dur: 12, what: '🚌 Bus → Trümmelbach', kind: 'travel' },
    { t: '09:15', dur: 65, what: '💧 TRÜMMELBACH FALLS — inside the mountain', kind: 'act', note: '🔁 MOVED HERE from Sep 20 so the cart could have that afternoon. Opens 09:00, CHF 14 · ten glacier cascades inside the rock, tunnel lift. Light is irrelevant — it is underground.' },
    { t: '10:25', dur: 8, what: '🚌 Bus → Stechelberg', kind: 'travel' },
    { t: '10:40', dur: 22, what: '🚡 Cable car Stechelberg → Gimmelwald → Mürren', kind: 'travel', note: 'the OTHER way up — today’s two ascents never repeat scenery' },
    { t: '11:05', dur: 20, what: '🧗 Rent via ferrata gear — Intersport Mürren', kind: 'act', note: 'harness, via ferrata set, helmet, gloves · ~CHF 30–40/person. 🔴 ASK how and where to return it: the route ends in Gimmelwald, one 5-min cable-car stop below.' },
    { t: '11:25', dur: 40, what: '🚡 Cable car Mürren → Birg → Schilthorn', kind: 'travel' },
    { t: '12:05', dur: 40, what: '🏔️ SCHILTHORN 2,970m — Skyline, Bond World', kind: 'act', note: '☁️ cloud makes this CHF 108 of fog, no refund' },
    { t: '12:45', dur: 75, what: '🍽️ Piz Gloria revolving restaurant — lunch', kind: 'food', note: 'the only restaurant meal today · ~$75–105 for the two · out of the food line' },
    { t: '14:00', dur: 40, what: '🌉 Thrill Walk at Birg — glass floor', kind: 'act' },
    { t: '14:45', dur: 20, what: '🚡 Down to Mürren · walk to the Sportchalet', kind: 'travel', note: 'the via ferrata starts at the Sportchalet, ~10 min from the cable car. 🪂 RESERVE SLOT: if wind cancelled yesterday’s flight, drop to Stechelberg from here for the 15:20 and skip the via ferrata.' },
    { t: '15:05', dur: 165, what: '🧗 VIA FERRATA Mürren → Gimmelwald', kind: 'act', note: '2.2 km, 300m down, ~2.5–3h, K3: ladders, iron rungs, cabled traverses 400m above the valley floor and a wire suspension bridge. Self-belayed the whole way — clip, move, clip. Open 09:00–18:00 to Oct 31; 15:05 is the latest sensible start. 🟠 If either of you hesitated on the Cliff Walk, take the ALLMENDHUBEL funicular + Mountain View trail instead.' },
    { t: '17:50', dur: 35, what: '🚡 Gimmelwald → Stechelberg', kind: 'travel', note: 'return the gear in Mürren first if the shop asks — Gimmelwald → Mürren is a 5-min cable car' },
    { t: '18:25', dur: 20, what: '🚌 Bus → Lauterbrunnen', kind: 'travel' },
