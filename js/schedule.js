...
const SCHEDULE = {
  ...
  20: { items: [
    ...
    { t: '14:45', dur: 50, what: '🍽️ Late lunch at Stechelberg', kind: 'food', note: 'you will have earned it — and this one IS in the $170. ❌ NOT the cart: on Sep 19 the Schreckfeld staff counted the queue at 15:20 and turned the tail away, a 16:30 arrival risks the same, and repeating Grindelwald was ruled out. Tomorrow is Schilthorn + Männlichen.' },
    ...
    { t: '19:30', dur: 90, what: 'Dinner in Lauterbrunnen', kind: 'food', note: 'tomorrow starts at 07:30 for a clear Schilthorn' }
  ]},
  21: { items: [
    { t: '07:30', dur: 35, what: 'Breakfast — check the Schilthorn webcam', kind: 'food', note: '☁️ Clear → the day below. Grey → FLIP IT: Wengen + Männlichen first (the Eiger shows under cloud more often than a 2,970m summit), Gimmelwald cows after lunch, Schilthorn only if it clears by 14:00 (last ascent 15:55). 🐄 Ask the desk where the cows are grazing today.' },
    { t: '08:10', dur: 15, what: '🚌 Bus → Stechelberg', kind: 'travel' },
    { t: '08:25', dur: 70, what: '🚡 Stechelberg → Gimmelwald → Mürren → Birg → SCHILTHORN', kind: 'travel', note: 'four cabins, ~70 min with the changes · first cabin from Stechelberg 07:55 · CHF 54/person return with the Half Fare Card · ❌ NOT Grindelwald: you have done First and Harder Kulm, and the 20-min kart was not worth 80 min of trains and ~CHF 80.' },
    { t: '09:35', dur: 70, what: '🏔️ SCHILTHORN 2,970m — Skyline, Bond World, Piz Gloria coffee', kind: 'act', note: '~200 peaks, the morning is when the summit is clear. A coffee while the restaurant turns — NOT lunch: you eat properly and cheaply in the valley at 13:30 and save the $75–105 a summit meal costs.' },
    { t: '10:50', dur: 10, what: '🚡 Schilthorn → Birg', kind: 'travel' },
    { t: '11:00', dur: 35, what: '🌉 Thrill Walk at Birg — glass floor', kind: 'act' },
    { t: '11:40', dur: 15, what: '🚡 Birg → Mürren', kind: 'travel' },
    { t: '12:00', dur: 45, what: '🐄 MÜRREN → GIMMELWALD on foot — the cow walk', kind: 'act', note: '45 min downhill on the farm path. Every Alpabzug is done, so the herds are on the village pastures with their bells on. Gimmelwald is a working hamlet: honesty fridges with Mutschli and aged alpine cheese for coins. 🪂 RESERVE SLOT: if wind cancelled yesterday’s flight, the operator’s 15:20 at Stechelberg replaces the Männlichen half of the day.' },
    { t: '12:50', dur: 10, what: '🚡 Gimmelwald → Stechelberg', kind: 'travel' },
    { t: '13:05', dur: 20, what: '🚌 Bus → Lauterbrunnen', kind: 'travel' },
    { t: '13:30', dur: 55, what: '🍽️ Lunch in Lauterbrunnen', kind: 'food', note: 'this one IS in the $170 — and it is the Piz Gloria money staying in your pocket' },
    { t: '14:35', dur: 15, what: '🚂 Lauterbrunnen → Wengen', kind: 'travel', note: 'Wengernalpbahn, every 30 min · car-free village' },
    { t: '14:55', dur: 10, what: '🚶 Wengen station → Männlichen cable car', kind: 'travel' },
    { t: '15:05', dur: 10, what: '🚡 Wengen → MÄNNLICHEN', kind: 'travel', note: 'every 20 min, runs to ~17:00 · ~CHF 14 with the card' },
    { t: '15:20', dur: 40, what: '👑 ROYAL WALK — crown platform, 2,343m', kind: 'act', note: '20 min up, 120m of climb · Lauterbrunnen valley one side, Grindelwald valley the other, Eiger–Mönch–Jungfrau in front. Skip it if the morning ran late — the trail is the priority.' },
    { t: '16:05', dur: 90, what: '🥾 PANORAMA TRAIL Männlichen → Kleine Scheidegg', kind: 'act', note: '4.5 km, wide and almost flat, gently downhill, the EIGER NORTH FACE straight ahead the whole way and lit by the afternoon sun. The postcard walk of the region. Cows and marmots in summer; late September the meadows are mostly yours.' },
    { t: '17:50', dur: 45, what: '🚂 Kleine Scheidegg → Wengen → Lauterbrunnen', kind: 'travel', note: '🔴 CHECK THE LAST TRAIN at Lauterbrunnen station in the morning — ~18:00–18:30 in September. ~18:35 home.' },
    { t: '19:30', dur: 90, what: 'Dinner', kind: 'food' }
  ]},
  22: { items: [
