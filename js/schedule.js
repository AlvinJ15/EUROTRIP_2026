...
const SCHEDULE = {
  ...
  20: { items: [
    { t: '08:15', dur: 50, what: 'Unhurried breakfast at the Spinne', kind: 'food', note: '✅ NO ALARM NEEDED. Checkout is 11:00; nothing pushes you out of this room.' },
    { t: '09:15', dur: 25, what: 'Check out, pack calmly', kind: 'bags' },
    { t: '09:50', dur: 35, what: '🚂 Grindelwald → Interlaken Ost', kind: 'travel', note: 'or the Zweilütschinen change, ~40 min door to door — take whichever leaves first' },
    { t: '10:35', dur: 25, what: '🚂 Interlaken Ost → Lauterbrunnen', kind: 'travel', note: 'arrive ~11:00 · trains every ~30 min' },
    { t: '11:05', dur: 25, what: '🧳 Bags into the Hotel Schützen', kind: 'bags', note: '✅ Your own hotel tonight. Room at 14:00 — this is a drop, and it is all you need. Ask for Trümmelbach’s last admission today while you are at the desk.' },
    { t: '11:30', dur: 30, what: '📷 First look at the village', kind: 'act', note: 'Staubbach gets its proper session on Tue morning at 08:45, front-lit.' },
    { t: '12:05', dur: 15, what: '🚡 Funicular → Grütschalp', kind: 'travel', note: '🔴 THE LAST SAFE DEPARTURE. Funicular + train run every 30 min; the 12:35 would reach Mürren at ~13:10 for a 13:20 check-in. If you want to eat up there, take the 11:35.' },
    { t: '12:20', dur: 20, what: '🚂 Panorama train → Mürren', kind: 'travel', note: 'arrives ~12:40' },
    { t: '12:40', dur: 40, what: '✍️ Walk to the meeting point, check in', kind: 'buffer', note: '40 min in hand, on foot, bags dropped, having eaten lightly.' },
    { t: '13:20', dur: 80, what: '🪂 PARAGLIDE — ✅ BOOKED, meets in MÜRREN', kind: 'fixed', fixed: true, note: '⭐ THE 13:20 SLOT IS THE BEST LIGHT OF THE DAY: solar noon ~13:25, valley floor fully lit AND the Eiger–Mönch–Jungfrau wall front-lit. 20–25 min airborne over Gimmelwald and the Trümmelbach falls, landing at STECHELBERG ~14:30 — confirm the landing field when you meet. 💰 $234/person, $468 for the two — from the Switzerland activities line, NOT from today’s $170 food + pocket. 🧥 Near-freezing at launch: gloves and a hat.' },
    { t: '14:45', dur: 50, what: '🍽️ Late lunch at Stechelberg', kind: 'food', note: 'you will have earned it — and this one IS in the $170. ❌ NOT the cart this afternoon: on Sep 19 the Schreckfeld staff counted the queue at 15:20 and turned the tail away; a 16:30 arrival risks the same. It goes to tomorrow 09:00, at opening.' },
    { t: '15:45', dur: 10, what: '🚌 Bus → Trümmelbach', kind: 'travel', note: 'two stops down the valley floor' },
    { t: '15:55', dur: 65, what: '💧 TRÜMMELBACH FALLS — inside the mountain', kind: 'act', note: 'Open to ~17:00 in September — you asked the Schützen for the exact last admission this morning. Ten glacier cascades inside the rock, tunnel lift, CHF 14. Underground, so light is irrelevant — which is why it can hold the late slot.' },
    { t: '17:05', dur: 20, what: '🚌 Bus → Lauterbrunnen', kind: 'travel' },
    { t: '17:30', dur: 25, what: '🏨 Collect the room at the Schützen', kind: 'bags' },
    { t: '18:00', dur: 60, what: '📷 Evening light on the EAST wall', kind: 'act', note: 'the floor loses the sun early behind 500m walls, but the east wall catches the last of it' },
    { t: '19:30', dur: 90, what: 'Dinner in Lauterbrunnen', kind: 'food', note: 'early night — tomorrow starts at 07:15 for the first cart of the day' }
  ]},
  21: { items: [
    { t: '07:15', dur: 30, what: 'Breakfast — early, on purpose', kind: 'food', note: '☁️ Check the Schilthorn webcam. Cloud up there does not change the morning: the cart and the toboggan run under cloud, only rain closes them.' },
    { t: '07:45', dur: 40, what: '🚂 Lauterbrunnen → Zweilütschinen → Grindelwald', kind: 'travel', note: 'every 30 min, one change · ~08:25 in Grindelwald · 5 min on foot to the First valley station' },
    { t: '08:30', dur: 10, what: '🎫 FIRST VALLEY COUNTER — cart + RETURN gondola', kind: 'fixed', fixed: true, note: '🔴 THE WHOLE POINT OF THE EARLY START. Cart tickets are sold ONLY here, at the counter, never online, and the daily number is limited — Sep 19 you were counted out of the Schreckfeld queue at 15:20. Buy RETURN gondola Grindelwald ↔ Schreckfeld (½ with the card) + MOUNTAIN CART CHF 25 per person, hold the paper, then go up. Min height 135 cm. ❌ NO trottibike — you come back down by cabin.' },
    { t: '08:40', dur: 20, what: '🚡 Gondola → SCHRECKFELD', kind: 'travel', note: 'the middle station, not the top' },
    { t: '09:00', dur: 35, what: '🛴 MOUNTAIN CART · Schreckfeld → Bort (3 km)', kind: 'act', note: '🔁 THE ONE YOU LOST. First cart of the day, nobody in front of you. A SEATED three-wheeler with a steering bar and brakes — no balance involved. 15–20 min of natural road. Closed if the road is wet — then go straight to Pfingstegg at 10:00.' },
    { t: '09:40', dur: 15, what: '🚡 Gondola Bort → Grindelwald village', kind: 'travel', note: 'the cabin, not the trottibike — neither of you rides, and a scooter down 4.5 km is a balance test' },
    { t: '10:00', dur: 15, what: '🚶 Walk to the Pfingstegg cable car', kind: 'travel', note: '15 min from the station · opens 10:00' },
    { t: '10:15', dur: 10, what: '🚡 Pfingstegg cable car up', kind: 'travel', note: '~CHF 34 return full — ask whether the Half Fare Card applies' },
    { t: '10:25', dur: 50, what: '🛷 PFINGSTEGG TOBOGGAN — 2–3 runs (+ Fly-Line)', kind: 'act', note: '736m summer toboggan on a rail: SEATED, brake lever in hand, ~3 min a run, CHF 8 each, ~5-min queues, NO daily cap. 🪂 The FLY-LINE alongside is a seated harness gliding slowly on a cable through the forest — the tamest ride on the mountain, if the toboggan looks faster than you want. Both shut when wet. No phones or bags on the run.' },
    { t: '11:15', dur: 25, what: '🚡 Down + walk to the station', kind: 'travel' },
    { t: '11:45', dur: 40, what: '🚂 Grindelwald → Lauterbrunnen', kind: 'travel', note: '~12:25' },
    { t: '12:30', dur: 15, what: '🚌 Bus → Stechelberg', kind: 'travel' },
    { t: '12:50', dur: 22, what: '🚡 Cable car Stechelberg → Gimmelwald → Mürren', kind: 'travel', note: 'the OTHER way up — today’s two ascents never repeat scenery' },
    { t: '13:15', dur: 20, what: '🚡 Cable car Mürren → Birg', kind: 'travel', note: '🔴 Ask at the Mürren desk: does Piz Gloria serve lunch to ~16:00? If not, eat at Birg now and take Piz Gloria for coffee and the view.' },
    { t: '13:40', dur: 35, what: '🌉 Thrill Walk at Birg — glass floor', kind: 'act' },
    { t: '14:20', dur: 15, what: '🚡 Birg → Schilthorn', kind: 'travel' },
    { t: '14:35', dur: 65, what: '🍽️ Piz Gloria revolving restaurant — late lunch', kind: 'food', note: 'the only restaurant meal today · ~$75–105 for the two · out of the food line' },
    { t: '15:40', dur: 35, what: '🏔️ SCHILTHORN 2,970m — Skyline, Bond World', kind: 'act', note: '☁️ cloud makes this CHF 108 of fog, no refund — if the webcam was grey at breakfast, stop at Mürren instead and walk to Gimmelwald. 🪂 RESERVE SLOT: if wind cancelled yesterday’s flight, skip Schilthorn, leave Birg by 14:30 and be at Stechelberg for the 15:20.' },
    { t: '16:15', dur: 40, what: '🚡 Schilthorn → Birg → Mürren', kind: 'travel', note: '~16:55 · check the last descent time at the Mürren desk on the way up' },
    { t: '17:05', dur: 30, what: '🚡 Mürren → Gimmelwald → Stechelberg', kind: 'travel', note: '❌ Allmendhubel came out — its last funicular is 17:00 and the toboggan hour ate that slot' },
    { t: '17:40', dur: 20, what: '🚌 Bus → Lauterbrunnen', kind: 'travel' },
    { t: '19:15', dur: 90, what: 'Dinner', kind: 'food' }
  ]},
  22: { items: [
    { t: '08:00', dur: 40, what: 'Breakfast', kind: 'food' },
    { t: '08:45', dur: 45, what: '📷 STAUBBACH — front-lit, 5 min from the hotel', kind: 'act', note: '⭐ ITS BEST HOUR. It faces east off the west wall; morning light hits it square. Free. Moved here from Sep 21 so the cart could have that morning.' },
    { t: '09:40', dur: 25, what: 'Check out', kind: 'bags' },
