...
{ day: 20, date: "Sun Sep 20", city: "Grindelwald → Lauterbrunnen → Mürren (paraglide)", status: "store",
      headline: "✅ Bags go straight to tonight’s hotel — no lockers, nothing unwatched while you fly",
      action: "🔁 SIMPLER THAN EARLIER VERSIONS OF THIS PLAN, which routed the bags through an Interlaken Ost locker for a Beatenberg flight. The flight now meets in MÜRREN at 13:20 and you sleep in LAUTERBRUNNEN, directly below it. So: check out of the Spinne 09:15, train to Lauterbrunnen (~11:00), four bags into the HOTEL SCHÜTZEN reception at 11:05 — room is at 14:00, but a drop is all you need — then up the funicular to Mürren with a daypack. Gloves, hat, a layer for 2,600m, water, nothing else. Collect the room ~17:30 after Trümmelbach.",
      cost: "Free — your own hotel holds them" },
